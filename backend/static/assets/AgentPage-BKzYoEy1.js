...
webbrowser.open("http://localhost:9173")`);try{const Me=await(await fetch(`https://agentapi.quanlymay.com/api/agents/${encodeURIComponent(R)}/tunnel/start`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({printer_ip:"127.0.0.1",printer_port:9173})})).json(),xt=(Me==null?void 0:Me.url)||(Me==null?void 0:Me.url_port)||"";Et&&Et({isOpen:!0,title:`🌐 WIM PrintAgentX — Agent ${(Ae==null?void 0:Ae.hostname)||R}`,ip:(Ae==null?void 0:Ae.local_ip)||"127.0.0.1",path:"/",html:"DIRECT_LAN",url:xt?`https://printagentx.com/?tunnel_url=${encodeURIComponent(xt)}`:"https://printagentx.com",agentUid:R})}catch(ge){console.error("Failed to start agent web tunnel:",ge),Et&&Et({isOpen:!0,title:`🌐 WIM PrintAgentX — Agent ${(Ae==null?void 0:Ae.hostname)||R}`,ip:(Ae==null?void 0:Ae.local_ip)||"127.0.0.1",path:"/",html:"DIRECT_LAN",url:"https://printagentx.com",agentUid:R})}}};return i.map(R=>{const ge=R.command==="emergency_restart";let ke=R.label,Me=R.icon||"🔧",xt=()=>ne(R.command,R.command_content);return R.command==="open_web_setting"?(ke="Mở WIM",Me=R.icon||"🌐",xt=he):R.command==="create_scan_shortcut"?(ke="Tạo shortcut Desktop",Me=R.icon||"🔗"):R.command==="emergency_restart"?(ke="Emergency Kill",Me=R.icon||"🔌",xt=p):R.command==="check_watchdog"&&(ke="Check watchdog",Me=R.icon||"🩺",xt=()=>{Ae&&(Pt("check_watchdog"),ht({text:"⌛ Đang kiểm tra watchdog...",isError:!1}),triggerAgentUtilityExec(Ae.agent_uid,"check_watchdog",R.command_content||"").then(Je=>{if(Je.ok&&Je.command_id){const zn=Date.now(),lr=setInterval(async()=>{if(Date.now()-zn>3e4){clearInterval(lr),ht({text:"⏱️ Timeout chờ kết quả (30s)",isError:!0}),Pt(null);return}try{const St=await getCommandStatus(Je.command_id);if(St.status==="success"){clearInterval(lr);const cr=St.result_payload||St.result||St.error||"Hoàn thành";At({isOpen:!0,title:"🩺 Check Watchdog",content:cr}),ht(null),Pt(null)}else if(St.status==="failed"){clearInterval(lr);const cr=St.error||St.result_payload||St.result||"Failed";At({isOpen:!0,title:"🩺 Check Watchdog",content:cr}),ht(null),Pt(null)}}catch{}},2e3)}else ht({text:"❌ "+(Je.error||"Không thể gửi lệnh"),isError:!0}),Pt(null)}).catch(Je=>{ht({text:"❌ "+Je.message,isError:!0}),Pt(null)}))}),e.jsxs("button",{onClick:xt,disabled:Ne!==null,style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"8px",background:"var(--color-surface-light)",border:ge?"1px solid rgba(239, 68, 68, 0.25)":"1px solid var(--color-surface-light)",borderRadius:"12px",padding:"16px 8px",cursor:Ne!==null?"not-allowed":"pointer",textAlign:"center",width:"100%",transition:"all 0.2s",opacity:Ne!==null?.6:1,minHeight:"108px",boxSizing:"border-box"},onMouseEnter:Je=>{Ne===null&&(Je.currentTarget.style.borderColor=ge?"#ef4444":"var(--color-primary)",Je.currentTarget.style.background=ge?"rgba(239, 68, 68, 0.05)":"rgba(59, 130, 246, 0.05)")},onMouseLeave:Je=>{Je.currentTarget.style.borderColor=ge?"rgba(239, 68, 68, 0.25)":"var(--color-surface-light)",Je.currentTarget.style.background="var(--color-surface-light)"},children:[e.jsx("div",{style:{fontSize:"1.6rem",display:"flex",alignItems:"center",justifyContent:"center"},children:Ne===R.command?e.jsx(dt,{size:"sm"}):Me}),e.jsx("div",{style:{fontSize:"0.72rem",fontWeight:600,color:ge?"#ef4444":"var(--color-text)",lineHeight:"1.2",wordBreak:"word-break"},children:ke})]},R.command)})})():e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>C("printers"),disabled:Ne!==null,style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"8px",background:"var(--color-surface-light)",border:"1px solid var(--color-surface-light)",borderRadius:"12px",padding:"16px 8px",cursor:Ne!==null?"not-allowed":"pointer",textAlign:"center",width:"100%",transition:"all 0.2s",opacity:Ne!==null?.6:1,minHeight:"108px",boxSizing:"border-box"},onMouseEnter:i=>{Ne===null&&(i.currentTarget.style.borderColor="var(--color-primary)",i.currentTarget.style.background="rgba(59, 130, 246, 0.05)")},onMouseLeave:i=>{i.currentTarget.style.borderColor="var(--color-surface-light)",i.currentTarget.style.background="var(--color-surface-light)"},children:[e.jsx("div",{style:{fontSize:"1.6rem",display:"flex",alignItems:"center",justifyContent:"center"},children:Ne==="printers"?e.jsx(dt,{size:"sm"}):"🖨️"}),e.jsx("div",{style:{fontSize:"0.72rem",fontWeight:600,color:"var(--color-text)",lineHeight:"1.2",wordBreak:"word-break"},children:"Danh sách Máy in"})]}),e.jsxs("button",{onClick:()=>C("scan"),disabled:Ne!==null,style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"8px",background:"var(--color-surface-light)",border:"1px solid var(--color-surface-light)",borderRadius:"12px",padding:"16px 8px",cursor:Ne!==null?"not-allowed":"pointer",textAlign:"center",width:"100%",transition:"all 0.2s",opacity:Ne!==null?.6:1,minHeight:"108px",boxSizing:"border-box"},onMouseEnter:i=>{Ne===null&&(i.currentTarget.style.borderColor="var(--color-primary)",i.currentTarget.style.background="rgba(59, 130, 246, 0.05)")},onMouseLeave:i=>{i.currentTarget.style.borderColor="var(--color-surface-light)",i.currentTarget.style.background="var(--color-surface-light)"},children:[e.jsx("div",{style:{fontSize:"1.6rem",display:"flex",alignItems:"center",justifyContent:"center"},children:Ne==="scan"?e.jsx(dt,{size:"sm"}):"📂"}),e.jsx("div",{style:{fontSize:"0.72rem",fontWeight:600,color:"var(--color-text)",lineHeight:"1.2",wordBreak:"word-break"},children:"Thư mục Scan"})]})]})}),e.jsxs("div",{style:{background:"var(--color-surface-light)",border:"1px solid var(--color-surface-light)",borderRadius:"8px",padding:"10px 12px",gridColumn:"1 / -1"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"8px"},children:[e.jsx("div",{style:{fontSize:"1.4rem"},children:"💻"}),e.jsx("div",{style:{fontSize:"0.8rem",fontWeight:700,color:"var(--color-text)"},children:"Thực hiện lệnh Run"})]}),e.jsxs("div",{style:{display:"flex",gap:"6px",marginBottom:"8px"},children:[e.jsx("input",{type:"text",value:L,onChange:i=>rr(i.target.value),onKeyDown:i=>{i.key==="Enter"&&L.trim()&&C("run_command",{command_line:L.trim()})},placeholder:"Nhập lệnh cần chạy...",disabled:Ne!==null,style:{flex:1,padding:"6px 10px",borderRadius:"6px",border:"1px solid var(--color-border)",background:"var(--color-surface)",color:"var(--color-text)",fontSize:"0.78rem",outline:"none",fontFamily:"monospace"}}),e.jsx("button",{onClick:()=>{L.trim()&&C("run_command",{command_line:L.trim()})},disabled:Ne!==null||!L.trim(),style:{padding:"6px 14px",borderRadius:"6px",border:"none",background:L.trim()?"var(--color-primary)":"var(--color-surface)",color:L.trim()?"#fff":"var(--color-text-secondary)",fontSize:"0.75rem",fontWeight:600,cursor:L.trim()&&Ne===null?"pointer":"not-allowed",transition:"all 0.2s",display:"flex",alignItems:"center",gap:"4px"},children:Ne==="run_command"?e.jsx(dt,{size:"sm"}):"▶ Run"})]}),e.jsx("div",{style:{display:"flex",gap:"6px",flexWrap:"wrap"},children:[{label:"dxdiag",cmd:"dxdiag",desc:"Cấu hình phần cứng"},{label:"msconfig",cmd:"msconfig",desc:"Cấu hình hệ thống"},{label:"ping",cmd:"ping google.com",desc:"Kiểm tra mạng"}].map(i=>e.jsx("button",{onClick:()=>rr(i.cmd),disabled:Ne!==null,title:i.desc,style:{padding:"3px 10px",borderRadius:"12px",border:"1px solid var(--color-border)",background:L===i.cmd?"rgba(59, 130, 246, 0.15)":"var(--color-surface)",color:L===i.cmd?"var(--color-primary)":"var(--color-text-secondary)",fontSize:"0.68rem",cursor:Ne!==null?"not-allowed":"pointer",transition:"all 0.2s",fontFamily:"monospace"},children:i.label},i.cmd))})]})]})]})]}),e.jsx("div",{style:n.modalFooter,children:e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.85rem"},onClick:()=>{Pe(null),ir(null),ht(null)},children:"Đóng cửa sổ"})})]}),u==="edit_ip"&&xe&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:" Thay đổi IP / Cấu hình FTP"}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>Pe(null),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("div",{style:{display:"flex",gap:"10px",marginBottom:"14px"},children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("label",{style:{display:"block",fontSize:"0.75rem",color:"var(--color-text-secondary)",marginBottom:"6px",fontWeight:600},children:"Chọn nhanh IP từ danh sách Agent:"}),e.jsxs("select",{style:{width:"100%",padding:"10px 12px",background:"var(--color-surface)",color:"var(--color-text)",border:"1px solid var(--color-border)",borderRadius:"6px",fontSize:"0.85rem",cursor:"pointer"},value:"",onChange:i=>{const V=i.target.value;V&&Jt(he=>{if(!he)return null;const R=he.newPort||"2130";return{...he,newIp:`${V}:${R}`,newPort:R}})},children:[e.jsx("option",{value:"",children:"-- Chọn Agent --"}),((Se==null?void 0:Se.agents)||[]).map((i,V)=>{const he=i.local_ip||i.ip||"",R=i.hostname||i.uid||`Agent ${V+1}`;return e.jsxs("option",{value:he,children:[R," (",he,")"]},V)})]})]}),e.jsxs("div",{style:{width:"100px"},children:[e.jsx("label",{style:{display:"block",fontSize:"0.75rem",color:"var(--color-text-secondary)",marginBottom:"6px",fontWeight:600},children:"Cổng FTP:"}),e.jsx("input",{type:"text",value:xe.newPort||"",onChange:i=>{const V=i.target.value;Jt(he=>{if(!he)return null;let R=he.newIp||"";return R.includes(":")&&(R=R.split(":")[0]),{...he,newPort:V,newIp:V?`${R}:${V}`:R}})},placeholder:"2130",style:n.modalInput})]})]}),e.jsxs("div",{style:{marginBottom:"14px"},children:[e.jsx("label",{style:{display:"block",fontSize:"0.75rem",color:"var(--color-text-secondary)",marginBottom:"6px",fontWeight:600},children:"Địa chỉ FTP (IP:PORT):"}),e.jsx("input",{type:"text",value:xe.newIp,onChange:i=>{const V=i.target.value;Jt(he=>{if(!he)return null;let R=he.newPort||"2130";return V.includes(":")&&(R=V.split(":")[1].trim()||R),{...he,newIp:V,newPort:R}})},placeholder:"Ví dụ: 192.168.1.100:2130",style:n.modalInput})]}),e.jsxs("div",{style:{fontSize:"0.68rem",color:"var(--color-text-secondary)",marginTop:"8px",fontStyle:"italic"},children:["Đường dẫn hiện tại trên máy in: ",xe.entry.folder||xe.entry.physical_path||xe.entry.folder_path]})]}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,background:"none",border:"1px solid var(--color-border)",color:"var(--color-text-secondary)",padding:"8px 16px"},onClick:()=>Pe(null),children:"Hủy bỏ"}),e.jsx("button",{style:{...n.smallBtn,background:"var(--color-primary)",border:"none",color:"#fff",padding:"8px 16px",fontWeight:"bold"},onClick:()=>{if(!(xe.newIp||"").trim().includes(":")){Qe("Yêu cầu nhập thủ công phải đi kèm cổng FTP (Ví dụ: 192.168.1.100:2130)","error");return}z()},disabled:!xe.newIp.trim(),children:"Lưu lại"})]})]}),u==="remote_lock"&&ut&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:"🔒 Khóa / Mở khóa máy từ xa"}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>Pe(null),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("p",{style:{margin:"0 0 16px 0",fontSize:"0.95rem",color:"var(--color-text)"},children:["Máy: ",e.jsx("strong",{children:ut.name})," (",ut.ip,")"]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[e.jsxs("button",{style:{display:"flex",alignItems:"center",gap:"12px",background:"#fee2e2",border:"1px solid #ef4444",borderRadius:"8px",padding:"12px 14px",cursor:"pointer",textAlign:"left"},onClick:()=>{Pe(null),Qe("Khóa máy...","info",2e3),modifyDeviceAddressss({ip:ut.ip,action:"lock_machine",agent_uid:ut.agentUid}).then(i=>{i.ok?Qe("Khóa máy","success"):Qe("Khóa máy thất bại","error")}).catch(i=>{Qe("Khóa máy thất bại","error")})},children:[e.jsx("div",{style:{fontSize:"1.4rem"},children:"🔒"}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"0.85rem",fontWeight:700,color:"#dc2626"},children:"Khóa máy"}),e.jsx("div",{style:{fontSize:"0.7rem",color:"#7f1d1d"},children:"Bật xác thực User Code, ngăn người dùng trái phép sử dụng máy"})]})]}),e.jsxs("button",{style:{display:"flex",alignItems:"center",gap:"12px",background:"#dcfce7",border:"1px solid #22c55e",borderRadius:"8px",padding:"12px 14px",cursor:"pointer",textAlign:"left"},onClick:()=>{Pe(null),Qe("Mở khóa máy...","info",2e3),modifyDeviceAddressss({ip:ut.ip,action:"enable_machine",agent_uid:ut.agentUid}).then(i=>{i.ok?Qe("Mở khóa máy","success"):Qe("Mở khóa thất bại","error")}).catch(i=>{Qe("Mở khóa thất bại","error")})},children:[e.jsx("div",{style:{fontSize:"1.4rem"},children:"🔓"}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"0.85rem",fontWeight:700,color:"#16a34a"},children:"Mở khóa máy"}),e.jsx("div",{style:{fontSize:"0.7rem",color:"#14532d"},children:"Tắt xác thực User Code, cho phép sử dụng máy tự do"})]})]})]})]})]}),u==="toshiba_vnc"&&ct&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsxs("h3",{style:n.modalTitle,children:["📺 Kết nối VNC - ",ct.printerName]}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>Pe(null),children:"×"})]}),e.jsx("div",{style:n.modalBody,children:Ze?e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"24px 0",gap:"16px"},children:[e.jsx("div",{style:{border:"4px solid rgba(255,255,255,0.1)",width:"36px",height:"36px",borderRadius:"50%",borderLeftColor:"#10b981",animation:"spin 1s linear infinite"}}),e.jsx("div",{style:{fontSize:"0.9rem",color:"var(--color-text-secondary)"},children:"Đang khởi tạo đường hầm VNC bảo mật qua Agent..."})]}):e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx("div",{style:{border:"1px solid var(--color-surface-light)",borderRadius:"8px",padding:"14px",background:"rgba(0,0,0,0.2)"},children:Z?e.jsxs("div",{style:{textAlign:"center",padding:"20px 10px"},children:[e.jsx("p",{style:{color:"#34d399",fontWeight:600,fontSize:"0.85rem",marginBottom:"14px"},children:"🟢 Đang bật Direct LAN (kết nối nội mạng). Vui lòng click nút dưới đây để mở giao diện Web VNC nội bộ:"}),e.jsx("button",{onClick:()=>{Pe(null),window.open(`http://${ct.ip}:49106/top.html?p=55105&wp=55106&w=1024&h=600&pa=0&op=0&c=0&osid=null`,"_blank")},style:{background:"#3b82f6",border:"none",borderRadius:"6px",padding:"10px 20px",color:"white",fontSize:"0.85rem",fontWeight:600,cursor:"pointer",boxShadow:"0 4px 12px rgba(59, 130, 246, 0.3)"},children:"🌐 Mở Web VNC Nội Mạng"})]}):I?e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},children:[e.jsx("div",{style:{position:"relative",border:"1px solid var(--color-surface-light)",borderRadius:"6px",overflow:"hidden",width:"100%",maxWidth:"800px",background:"#000",cursor:"crosshair",boxShadow:"0 8px 24px rgba(0,0,0,0.5)"},children:e.jsx("img",{id:"vnc-live-viewport",src:`${BASE_URL}/api/vnc/stream?agent_uid=${ct.agentUid}&ip=${ct.ip}&port=49105&t=${Date.now()}`,alt:"Màn hình Live VNC",onClick:async i=>{const V=i.currentTarget.getBoundingClientRect(),he=i.clientX-V.left,R=i.clientY-V.top,ge=he/V.width,ke=R/V.height,Me=Math.round(ge*1024),xt=Math.round(ke*600);try{await fetch(`${BASE_URL}/api/vnc/click`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({agent_uid:ct.agentUid,ip:ct.ip,port:49105,x:Me,y:xt})})}catch(Je){console.error("VNC Click error:",Je)}},style:{display:"block",width:"100%",height:"auto",pointerEvents:"auto"}})}),e.jsx("div",{style:{fontSize:"0.75rem",color:"#a78bfa",fontWeight:500},children:"⚡ Click chuột trực tiếp lên màn hình để tương tác (giống UltraViewer)"})]}):e.jsx("div",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",textAlign:"center",padding:"10px"},children:"Đang kết nối luồng hình ảnh..."})}),!Z&&e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"0 4px"},children:[e.jsxs("span",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)"},children:["Địa chỉ VPS: ",e.jsx("strong",{style:{color:"white",fontFamily:"monospace"},children:I})," (Pass: ",e.jsx("strong",{style:{color:"white",fontFamily:"monospace"},children:"d9kvgn"}),")"]}),e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx("button",{onClick:()=>{navigator.clipboard.writeText(I),Qe("Đã sao chép địa chỉ VNC","success")},style:{background:"rgba(255,255,255,0.08)",border:"none",borderRadius:"4px",padding:"4px 8px",color:"white",fontSize:"0.7rem",cursor:"pointer"},children:"Sao chép IP"}),e.jsx("button",{onClick:()=>{navigator.clipboard.writeText("d9kvgn"),Qe("Đã sao chép mật khẩu","success")},style:{background:"rgba(255,255,255,0.08)",border:"none",borderRadius:"4px",padding:"4px 8px",color:"white",fontSize:"0.7rem",cursor:"pointer"},children:"Sao chép Pass"})]})]}),e.jsxs("div",{style:{display:"flex",gap:"10px",marginTop:"4px"},children:[e.jsx("a",{href:`vnc://${I}`,style:{flex:1,display:"inline-flex",alignItems:"center",justifyContent:"center",gap:"6px",textDecoration:"none",background:"rgba(16, 185, 129, 0.1)",border:"1px solid #10b981",borderRadius:"6px",padding:"8px 12px",color:"#10b981",fontSize:"0.78rem",fontWeight:600,cursor:"pointer"},children:"🚀 Mở bằng VNC App ngoài"}),e.jsx("button",{onClick:()=>{Pe(null),H(ct.ip,"","GET",null,!1,ct.agentUid,49106)},style:{flex:1,background:"rgba(59, 130, 246, 0.1)",border:"1px solid #3b82f6",borderRadius:"6px",padding:"8px 12px",color:"#3b82f6",fontSize:"0.78rem",fontWeight:600,cursor:"pointer"},children:"🌐 Thử mở Web noVNC"})]})]})]})})]})]})})}),e.jsx(et,{children:Q.isOpen&&e.jsx("div",{style:n.confirmOverlay,onClick:()=>Bt(i=>({...i,isOpen:!1})),children:e.jsxs(Ve.div,{style:n.confirmModalCard,onClick:i=>i.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsxs("h3",{style:n.modalTitle,children:["⚠️ ",Q.title]}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>Bt(i=>({...i,isOpen:!1})),children:"×"})]}),e.jsx("div",{style:n.modalBody,children:e.jsx("p",{style:{fontSize:"0.82rem",color:"var(--color-text)",lineHeight:1.4,margin:0,whiteSpace:"pre-line"},children:Q.message})}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",background:"var(--color-error)",borderColor:"var(--color-error)",color:"white"},onClick:()=>{var i;Bt(V=>({...V,isOpen:!1})),(i=Q.onConfirm)==null||i.call(Q)},children:"Đồng ý"}),e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>Bt(i=>({...i,isOpen:!1})),children:"Hủy bỏ"})]})]})})}),e.jsx(et,{children:m.isOpen&&e.jsx("div",{style:n.confirmOverlay,children:e.jsxs(Ve.div,{style:{...n.confirmModalCard,maxWidth:"460px",width:"90%",textAlign:"center",border:"1px solid rgba(239, 68, 68, 0.4)",background:"rgba(24, 24, 32, 0.98)",padding:"28px 24px",borderRadius:"16px",boxShadow:"0 20px 40px rgba(0,0,0,0.6)"},onClick:i=>i.stopPropagation(),initial:{scale:.9,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.9,opacity:0},children:[e.jsx("div",{style:{fontSize:"2.8rem",marginBottom:"10px"},children:"🌐"}),e.jsx("h3",{style:{fontSize:"1.15rem",fontWeight:700,color:"#f87171",margin:"0 0 8px 0"},children:"Cảnh báo Public IP / Cho phép kết nối"}),e.jsxs("p",{style:{fontSize:"0.86rem",color:"#9ca3af",lineHeight:1.5,margin:"0 0 16px 0"},children:["Public IP hiện tại của trình duyệt (",e.jsx("strong",{children:m.ip||"Chưa xác định"}),") chưa có trong danh sách được kết nối với Agent."]}),e.jsxs("div",{style:{textAlign:"left",marginBottom:"16px"},children:[e.jsx("label",{style:{fontSize:"0.8rem",fontWeight:600,color:"#e5e7eb",display:"block",marginBottom:"6px"},children:"Nhập Public IP muốn kết nối với Agent:"}),e.jsx("div",{style:{position:"relative"},children:e.jsx("input",{type:"text",value:Ge,onChange:i=>_t(i.target.value),placeholder:"Ví dụ: 116.98.0.59 hoặc *",style:{width:"100%",padding:"10px 14px",fontSize:"0.9rem",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.2)",background:"rgba(0,0,0,0.4)",color:"#fff",outline:"none",boxSizing:"border-box"}})}),Sr&&e.jsxs("div",{style:{fontSize:"0.78rem",color:"#ef4444",marginTop:"6px"},children:["⚠️ ",Sr]})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[e.jsx("button",{onClick:()=>Gn(),disabled:Wt,style:{width:"100%",padding:"11px 16px",fontSize:"0.9rem",fontWeight:700,background:"linear-gradient(135deg, #10b981 0%, #059669 100%)",color:"white",border:"none",borderRadius:"8px",cursor:Wt?"not-allowed":"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:"8px",boxShadow:"0 4px 12px rgba(16, 185, 129, 0.3)"},children:Wt?e.jsx(dt,{size:"sm"}):"Kết nối Public IP"}),e.jsx("button",{onClick:()=>{window.location.href="/dashboard"},style:{width:"100%",padding:"9px 16px",fontSize:"0.82rem",fontWeight:600,background:"transparent",color:"#9ca3af",border:"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"8px",cursor:"pointer"},children:"Quay về Dashboard ↗"})]})]})})}),e.jsx(et,{children:ee.isOpen&&e.jsx("div",{style:n.confirmOverlay,onClick:()=>Gt(i=>({...i,isOpen:!1})),children:e.jsxs(Ve.div,{style:{...n.confirmModalCard,maxWidth:"440px",width:"90%"},onClick:i=>i.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:"⚠️ Xác nhận xóa điểm scan"}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>Gt(i=>({...i,isOpen:!1})),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("div",{style:{marginBottom:"14px",color:"var(--color-text)",fontSize:"0.85rem",lineHeight:1.5},children:["Tên điểm scan: ",e.jsxs("strong",{children:['"',((Pr=ee.entry)==null?void 0:Pr.name)||((kr=ee.entry)==null?void 0:kr.name_1)||((Ar=ee.entry)==null?void 0:Ar.email_address)||((Er=ee.entry)==null?void 0:Er.folder)||((jr=ee.entry)==null?void 0:jr.registration_no)||"không tên",'"']}),((Rr=ee.entry)==null?void 0:Rr.registration_no)&&e.jsxs("span",{style:{display:"block",color:"var(--color-muted)",fontSize:"0.78rem",marginTop:"2px"},children:["Mã đăng ký: #",(Lr=ee.entry)==null?void 0:Lr.registration_no]})]}),e.jsxs("div",{style:n.formGroup,children:[e.jsx("label",{style:n.formLabel,children:"Relay Agent thực thi *"}),e.jsx("select",{style:n.modalInput,value:ee.agentUid,onChange:i=>Gt(V=>({...V,agentUid:i.target.value})),children:(Se&&Se.agents||[]).filter(i=>i.is_agent_active).map(i=>e.jsxs("option",{value:i.agent_uid,children:[i.hostname," (",i.local_ip,")"]},i.agent_uid))}),e.jsx("span",{style:n.formHelpText,children:"Chọn máy Agent trong mạng LAN sẽ gửi lệnh xóa tới máy photocopy."})]})]}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",background:"var(--color-error)",borderColor:"var(--color-error)",color:"white"},onClick:J,children:"Xác nhận xóa"}),e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>Gt(i=>({...i,isOpen:!1})),children:"Hủy bỏ"})]})]})})}),e.jsx(et,{children:G.isOpen&&e.jsx("div",{style:n.confirmOverlay,onClick:()=>gt(i=>({...i,isOpen:!1})),children:e.jsxs(Ve.div,{style:n.confirmModalCard,onClick:i=>i.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:"📦 Cài đặt Driver từ xa"}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>gt(i=>({...i,isOpen:!1})),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"6px",marginBottom:"14px"},children:[e.jsx("label",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",fontWeight:600},children:"📂 chọn phiên bản Driver cần cài đặt (khớp từ Storage catalog):"}),(()=>{var he;const i=[];if(G.suggestedDrivers&&Array.isArray(G.suggestedDrivers)&&G.suggestedDrivers.length>0&&G.suggestedDrivers.forEach(R=>{R.drivers&&Array.isArray(R.drivers)&&R.drivers.forEach(ge=>{i.push({name:ge.name,url:ge.url,brand:R.brand||G.brand,model:R.model||G.model,label:`[${String(R.brand||G.brand||"").toUpperCase()} ${R.model||G.model}] ${ge.name}`})})}),i.length===0&&G.driverName&&G.driverUrl&&i.push({name:G.driverName,url:G.driverUrl,brand:G.brand||"Ricoh",model:G.model||"Photocopy",label:`[${String(G.brand||"RICOH").toUpperCase()} ${G.model||""}] ${G.driverName}`}),i.length===0)return e.jsx("div",{style:{padding:"10px",fontSize:"0.82rem",color:"var(--color-error)",fontStyle:"italic",background:"rgba(239, 68, 68, 0.08)",border:"1px solid rgba(239, 68, 68, 0.3)",borderRadius:"6px"},children:"⚠️ Không tìm thấy phiên bản driver nào phù hợp trong Storage catalog."});const V=G.driverUrl||((he=i[0])==null?void 0:he.url)||"";return e.jsx("select",{value:V,onChange:R=>{const ge=i.find(ke=>ke.url===R.target.value);ge&&gt(ke=>({...ke,driverName:ge.name,driverUrl:ge.url,brand:ge.brand||ke.brand,model:ge.model||ke.model}))},style:{fontSize:"0.82rem",padding:"8px 10px",background:"var(--color-bg)",color:"var(--color-text)",border:"1px solid var(--color-surface-light)",borderRadius:"6px",width:"100%",cursor:"pointer",fontWeight:600},children:i.map((R,ge)=>e.jsx("option",{value:R.url,children:R.label},ge))})})()]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"6px"},children:[e.jsx("label",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",fontWeight:600},children:"💻 Chọn Máy đại diện (Agent) để thực hiện cài đặt:"}),!(Se!=null&&Se.agents)||Se.agents.filter(i=>i.is_agent_active).length===0?e.jsx("div",{style:{padding:"10px",fontSize:"0.82rem",color:"var(--color-text-secondary)",fontStyle:"italic",background:"var(--color-input-bg)",border:"1px solid var(--color-border)",borderRadius:"6px"},children:"Không có Agent online trong LAN này"}):e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"8px",padding:"10px",background:"var(--color-input-bg)",border:"1px solid var(--color-border)",borderRadius:"6px",maxHeight:"200px",overflowY:"auto"},children:Se.agents.filter(i=>i.is_agent_active).map(i=>{const V=G.selectedAgentUids.includes(i.agent_uid);return e.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",fontSize:"0.82rem",color:"var(--color-text)"},children:[e.jsx("input",{type:"checkbox",checked:V,onChange:he=>{gt(R=>{const ge=R.selectedAgentUids;return he.target.checked?{...R,selectedAgentUids:[...ge,i.agent_uid]}:{...R,selectedAgentUids:ge.filter(ke=>ke!==i.agent_uid)}})},style:{width:"16px",height:"16px",accentColor:"var(--color-primary)"}}),e.jsxs("span",{children:[i.hostname," (",i.local_ip,")"]})]},i.agent_uid)})})]})]}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",background:"var(--color-primary)",borderColor:"var(--color-primary)",color:"white"},disabled:G.selectedAgentUids.length===0,onClick:()=>{const i=G;gt(ke=>({...ke,isOpen:!1}));const V=i.driverUrl||"",he=i.driverName||i.model||"Driver",R=i.brand||"Ricoh",ge=i.model||"Photocopy";i.selectedAgentUids.forEach(ke=>{te(i.printerId,R,ge,he,V,ke,i.printerIp,i.macId)})},children:"Bắt đầu cài đặt"}),e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>gt(i=>({...i,isOpen:!1})),children:"Hủy bỏ"})]})]})})}),e.jsx(et,{children:W.isOpen&&e.jsx("div",{style:{...n.confirmOverlay,zIndex:170},onClick:()=>Xe(i=>({...i,isOpen:!1,error:""})),children:e.jsxs(Ve.div,{style:n.confirmModalCard,onClick:i=>i.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:W.title}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>Xe(i=>({...i,isOpen:!1,error:""})),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("p",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",margin:"0 0 10px 0",lineHeight:1.5},children:[W.hint," Ví dụ: ",e.jsx("code",{style:{background:"var(--color-surface-light)",padding:"1px 5px",borderRadius:4},children:"192.168.1.15"})]}),e.jsx("input",{autoFocus:!0,type:"text",value:W.value,onChange:i=>Xe(V=>({...V,value:i.target.value,error:""})),onKeyDown:i=>{if(i.key==="Enter"){const V=/^(\d{1,3}\.){3}\d{1,3}$/;if(!V.test(W.value.trim())){Xe(ge=>({...ge,error:"IP không hợp lệ! Vui lòng nhập đúng dạng x.x.x.x"}));return}const he=(W.changeAllTo||"").trim();if(he&&!V.test(he)){Xe(ge=>({...ge,error:"IP mới không hợp lệ! Vui lòng nhập đúng dạng x.x.x.x hoặc để trống."}));return}const R=W.onConfirm;Xe(ge=>({...ge,isOpen:!1,error:""})),R(W.value.trim(),he)}i.key==="Escape"&&Xe(V=>({...V,isOpen:!1,error:""}))},placeholder:"192.168.1.x",style:{width:"100%",padding:"10px 12px",borderRadius:"8px",border:W.error?"1.5px solid var(--color-error)":"1.5px solid var(--color-surface-light)",background:"var(--color-background)",color:"var(--color-text)",fontSize:"0.9rem",fontFamily:"monospace",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:i=>{W.error||(i.target.style.borderColor="var(--color-primary)")},onBlur:i=>{W.error||(i.target.style.borderColor="var(--color-surface-light)")}}),W.title.includes("Kiểm tra")&&e.jsxs("div",{style:{marginTop:"12px"},children:[e.jsx("p",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",margin:"0 0 6px 0",lineHeight:1.5},children:"Thay đổi tất cả FTP Scan trùng IP trên thành IP mới (Tùy chọn):"}),e.jsx("input",{type:"text",value:W.changeAllTo||"",onChange:i=>Xe(V=>({...V,changeAllTo:i.target.value,error:""})),placeholder:"Ví dụ: 192.168.1.43",style:{width:"100%",padding:"10px 12px",borderRadius:"8px",border:"1.5px solid var(--color-surface-light)",background:"var(--color-background)",color:"var(--color-text)",fontSize:"0.9rem",fontFamily:"monospace",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:i=>{i.target.style.borderColor="var(--color-primary)"},onBlur:i=>{i.target.style.borderColor="var(--color-surface-light)"}})]}),W.error&&e.jsxs("p",{style:{margin:"6px 0 0 0",fontSize:"0.72rem",color:"var(--color-error)"},children:["⚠️ ",W.error]}),W.scanStatus&&e.jsx("div",{style:{marginTop:"10px",padding:"8px 10px",borderRadius:"6px",background:"var(--color-surface-light)",fontSize:"0.74rem",color:"var(--color-text-secondary)",lineHeight:1.4,whiteSpace:"pre-wrap",border:"1px solid var(--color-surface-border)"},children:W.scanStatus})]}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",background:"var(--color-primary)",borderColor:"var(--color-primary)",color:"white"},onClick:()=>{const i=/^(\d{1,3}\.){3}\d{1,3}$/;if(!i.test(W.value.trim())){Xe(R=>({...R,error:"IP không hợp lệ! Vui lòng nhập đúng dạng x.x.x.x"}));return}const V=(W.changeAllTo||"").trim();if(V&&!i.test(V)){Xe(R=>({...R,error:"IP mới không hợp lệ! Vui lòng nhập đúng dạng x.x.x.x hoặc để trống."}));return}const he=W.onConfirm;Xe(R=>({...R,isOpen:!1,error:""})),he(W.value.trim(),V)},children:"✅ Xác nhận"}),e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>Xe(i=>({...i,isOpen:!1,error:""})),children:"Hủy"})]})]})})}),e.jsx(et,{children:be.isOpen&&e.jsx("div",{style:{...n.confirmOverlay,zIndex:180,alignItems:"flex-start",paddingTop:"5vh"},onClick:()=>At(i=>({...i,isOpen:!1})),children:e.jsxs(Ve.div,{style:{...n.confirmModalCard,maxWidth:"680px",width:"95%",maxHeight:"88vh",display:"flex",flexDirection:"column"},onClick:i=>i.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:{...n.modalTitle,fontSize:"0.85rem"},children:be.title}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>At(i=>({...i,isOpen:!1})),children:"×"})]}),be.title.includes("settings.json")?e.jsxs("div",{style:{display:"flex",flexDirection:"column",flex:1,minHeight:0},children:[e.jsx("textarea",{ref:nt,value:Ie,onChange:i=>fr(i.target.value),style:{flex:1,overflow:"auto",margin:0,padding:"12px",background:"var(--color-background)",border:"1px solid var(--color-surface-light)",borderRadius:"8px",fontSize:"0.72rem",lineHeight:1.55,fontFamily:"'Consolas', 'Monaco', monospace",color:"var(--color-text)",minHeight:"380px",outline:"none",resize:"none"}}),ft&&e.jsx("div",{style:{marginTop:8,fontSize:11,padding:"6px 10px",borderRadius:6,background:ft.startsWith("❌")?"rgba(239,68,68,0.1)":ft.startsWith("✔️")?"rgba(34,197,94,0.1)":"rgba(234,179,8,0.1)",color:ft.startsWith("❌")?"#f87171":ft.startsWith("✔️")?"#4ade80":"var(--color-warning)",border:`1px solid ${ft.startsWith("❌")?"rgba(239,68,68,0.15)":ft.startsWith("✔️")?"rgba(34,197,94,0.15)":"rgba(234,179,8,0.15)"}`},children:ft})]}):be.content&&typeof be.content=="string"&&(be.content.trim().startsWith("data:image/")||be.content.trim().startsWith("iVBORw0KGgo"))?e.jsx(ai,{src:be.content.trim().startsWith("data:image/")?be.content.trim():`data:image/png;base64,${be.content.trim()}`,alt:be.title||"Desktop Screenshot"}):e.jsx("pre",{ref:nt,style:{flex:1,overflow:"auto",margin:0,padding:"12px",background:"var(--color-background)",border:"1px solid var(--color-surface-light)",borderRadius:"8px",fontSize:"0.68rem",lineHeight:1.55,fontFamily:"'Consolas', 'Monaco', monospace",whiteSpace:"pre-wrap",wordBreak:"break-all",color:"var(--color-text)",minHeight:0},children:vr(be.content)}),e.jsxs("div",{style:{...n.modalFooter,marginTop:"10px"},children:[be.title.includes("settings.json")&&e.jsx("button",{disabled:ve,style:{...n.smallBtn,padding:"8px 14px",fontSize:"0.78rem",background:ve?"rgba(99,102,241,0.6)":"var(--color-primary)",borderColor:"var(--color-primary)",color:"#fff",cursor:ve?"not-allowed":"pointer"},onClick:pe,children:ve?"⌛ Đang lưu...":"💾 Lưu cấu hình"}),e.jsx("button",{style:{...n.smallBtn,padding:"8px 14px",fontSize:"0.78rem"},onClick:()=>{navigator.clipboard.writeText(be.title.includes("settings.json")?Ie:vr(be.content)).catch(()=>{})},children:"📋 Copy"}),e.jsx("button",{style:{...n.smallBtn,padding:"8px 14px",fontSize:"0.78rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>At(i=>({...i,isOpen:!1})),children:"Đóng"})]})]})})}),e.jsx(et,{children:st&&st.isOpen&&e.jsx(li,{webPreviewModal:st,handleCloseWebPreview:de,directLan:Z,webPreviewLoading:ot,previewIframeRef:Mt,previewBlobUrl:Dt,setWebPreviewModal:Et})}),e.jsx(et,{children:it.isOpen&&e.jsx(Ve.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},style:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.85)",backdropFilter:"blur(8px)",zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center",padding:"16px"},onClick:()=>Xt(i=>({...i,isOpen:!1})),children:e.jsxs(Ve.div,{initial:{scale:.9,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.9,opacity:0},style:{background:"#121826",border:"1px solid rgba(0, 204, 255, 0.3)",borderRadius:"16px",width:"100%",maxWidth:"680px",maxHeight:"85vh",display:"flex",flexDirection:"column",boxShadow:"0 20px 50px rgba(0,0,0,0.6)",overflow:"hidden"},onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{style:{padding:"16px 20px",borderBottom:"1px solid rgba(255,255,255,0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",background:"rgba(0, 204, 255, 0.05)"},children:[e.jsxs("div",{children:[e.jsx("h3",{style:{margin:0,fontSize:"1.05rem",color:"#00ccff",display:"flex",alignItems:"center",gap:"8px"},children:"📋 Tệp dữ liệu scan_points.json"}),e.jsxs("div",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",marginTop:"4px"},children:[it.copierName," · MAC: ",it.macId||"N/A"]})]}),e.jsx("button",{style:{background:"none",border:"none",color:"var(--color-text-secondary)",fontSize:"1.3rem",cursor:"pointer"},onClick:()=>Xt(i=>({...i,isOpen:!1})),children:"✕"})]}),e.jsx("div",{style:{padding:"16px 20px",overflowY:"auto",flex:1},children:it.loading?e.jsx("div",{style:{textAlign:"center",padding:"40px 0",color:"#00ccff"},children:"⏳ Đang tải nội dung tệp scan_points.json..."}):e.jsxs("div",{children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"10px"},children:[e.jsxs("span",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)"},children:["Local Agent path: ",e.jsx("code",{style:{color:"#00ccff"},children:".../GoPrinxAgent/scan_points.json"})]}),e.jsx("button",{style:{background:"rgba(0, 255, 136, 0.15)",border:"1px solid rgba(0, 255, 136, 0.3)",color:"#00ff88",padding:"4px 10px",borderRadius:"6px",fontSize:"0.75rem",cursor:"pointer",fontWeight:600},onClick:()=>{navigator.clipboard.writeText(JSON.stringify(it.jsonData,null,2)),Qe("Đã sao chép nội dung scan_points.json!","success")},children:"📋 Copy JSON"})]}),e.jsx("pre",{style:{background:"#0a0d14",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"8px",padding:"14px",color:"#a0aec0",fontSize:"0.8rem",fontFamily:"Consolas, Monaco, monospace",overflowX:"auto",whiteSpace:"pre-wrap",wordBreak:"break-word",margin:0,maxHeight:"450px"},children:JSON.stringify(it.jsonData,null,2)})]})}),e.jsx("div",{style:{padding:"12px 20px",borderTop:"1px solid rgba(255,255,255,0.08)",display:"flex",justifyContent:"flex-end",background:"rgba(0,0,0,0.2)"},children:e.jsx("button",{style:{background:"var(--color-surface-light)",border:"1px solid rgba(255,255,255,0.1)",color:"#fff",padding:"8px 18px",borderRadius:"8px",fontSize:"0.82rem",cursor:"pointer"},onClick:()=>Xt(i=>({...i,isOpen:!1})),children:"Đóng"})})]})})})]})}const di=(t={})=>{const{showToast:s,pollCommandStatus:l,utilityCommands:u}=t,[_,I]=b.useState([]),[N,K]=b.useState(()=>localStorage.getItem("goxprint_selected_public_ip")||localStorage.getItem("gox_connect_public_ip")||""),[_e,X]=b.useState(""),[U,E]=b.useState(()=>localStorage.getItem("goxprint_target_internal_ip")||""),[le,$]=b.useState(!1),[w,Q]=b.useState(()=>{try{const h=localStorage.getItem("goxprint_expanded_printers");return h?JSON.parse(h):{}}catch{return{}}}),[m,A]=b.useState({}),[O,L]=b.useState({}),[ee,Z]=b.useState({}),[xe,Ie]=b.useState({}),[Te,te]=b.useState({isOpen:!1,copier:null,oldIp:"",newIp:"",targetAgentUid:"",status:"",error:""}),[ce,re]=b.useState({isOpen:!1,ip:""}),[we,S]=b.useState(""),q=b.useRef({}),[H]=b.useState(()=>localStorage.getItem("goxprint_last_viewed_copier_id")),F=b.useRef(N);b.useEffect(()=>{F.current=N},[N]);const D=b.useCallback(async(h=!1)=>{h&&$(!0);try{const f=await Hn(F.current||void 0),y=(f==null?void 0:f.rows)||(Array.isArray(f)?f:[]);I(y);try{const r=((f==null?void 0:f.client_ip)||"").trim();r&&S(r);const c=!!(f!=null&&f.is_allowed),p=(f==null?void 0:f.active_public_ips)||[],o=F.current||r,g=[];y.forEach(k=>{(k.agents||[]).forEach(T=>{const j=(T.public_ip||T.wan_ip||T.ip||"").trim(),M=(T.local_ip||"").trim();o&&(j&&j===o||M&&M===o)&&g.push(T)})});const a=g.length>0,P=!!F.current||c||a;if(console.log("=================================================="),console.log("🌐 [PUBLIC IP ACCESS CONTROL CHECK]"),console.log("📌 IP Public hiện tại của trình duyệt:",r),F.current&&console.log("⚡ IP Public do người dùng chỉ định kết nối:",F.current),console.log("🛡️ Danh sách Public IP đang Active trên Server:",p),console.log("✅ Quyền truy cập toàn bộ LAN (Is Whitelisted/Allowed):",c||F.current?"CÓ (FULL ACCESS)":"KHÔNG (LIMITED BY AGENT PUBLIC IP)"),console.log("💻 Danh sách Agent có cùng Public IP:",g.length>0?g:P?"Đang mở Full LAN (Tất cả Agent)":"Không tìm thấy Agent cùng IP"),console.log("=================================================="),!P&&r){console.warn(`[ACCESS DENIED] Public IP ${r} is not allowed and not in the same network.`),re({isOpen:!0,ip:r});return}console.log("[FRONTEND SCANPOINTS VPS] DANH SÁCH DANH BẠ TỪ SCANPOINTS VPS (< 3 NGÀY):"),y.forEach(k=>{(k.printers||[]).forEach(T=>{var d;const j=T.address_book_sync||{},M=Array.isArray(j.address_list)?j.address_list:((d=j.address_book_data)==null?void 0:d.address_list)||[],ie=T.mac_address||T.mac_id||"—";M.length>0&&console.log(`📌 Máy in [${T.printer_name||T.name}] - IP: ${T.ip} | MAC: ${ie} (${M.length} điểm scan trong ScanPoints VPS):`,M)})}),console.log("==================================================")}catch(r){console.error("Console log error:",r)}y.length>0?X(()=>{const r=F.current.trim();if(r){const p=y.find(o=>(o.public_ip||o.wan_ip||"").trim()===r?!0:(o.agents||[]).some(a=>(a.public_ip||a.wan_ip||a.ip||"").trim()===r));return p?(localStorage.setItem("goxprint_selected_lan_uid",p.lan_uid),p.lan_uid):r}const c=((f==null?void 0:f.client_ip)||"").trim();if(c){const p=y.find(o=>(o.public_ip||o.wan_ip||"").trim()===c?!0:(o.agents||[]).some(a=>(a.public_ip||a.wan_ip||a.ip||"").trim()===c));if(p)return localStorage.setItem("goxprint_selected_lan_uid",p.lan_uid),p.lan_uid}return localStorage.removeItem("goxprint_selected_lan_uid"),""}):X(""),h&&s("Tải mạng LAN","success")}catch(f){console.error("Failed to fetch LAN sites:",f),h&&s("Tải mạng LAN thất bại","error")}finally{$(!1)}},[s]);b.useEffect(()=>{D()},[D]),b.useEffect(()=>{const h=setInterval(()=>{D()},6e4);return()=>clearInterval(h)},[D]);const oe=b.useMemo(()=>{if(!_||_.length===0)return[];const h=N.trim();if(h){const f=_.filter(y=>(y.public_ip||y.wan_ip||"").trim()===h?!0:(y.agents||[]).some(c=>(c.public_ip||c.wan_ip||c.ip||"").trim()===h));return f.length>0?f:[]}return _},[_,N]),x=b.useMemo(()=>{const h=N.trim();if(h){if(_&&_.length>0){const f=_.find(y=>(y.public_ip||y.wan_ip||y.lan_uid||"").trim()===h?!0:(y.agents||[]).some(c=>(c.public_ip||c.wan_ip||c.ip||"").trim()===h));if(f)return f}return{lead:"default",lan_uid:h,lan_name:`IP Public ${h}`,public_ip:h,wan_ip:h,active_agents:0,agents:[],emails:[],printers:[]}}if(!_||_.length===0)return null;if(_e){const f=_.find(y=>y.lan_uid===_e);if(f)return f}return null},[_,N,_e]),v=b.useCallback((h,f=!0)=>{var a,P,k;if(!h||!h.lan_uid){s("Không có mạng LAN nào được chọn để thực hiện quét!","error",4e3);return}const y=h.lan_uid,r=Date.now();if((P=(a=t.commandStatus)==null?void 0:a[`scan_lan_${y}`])==null?void 0:P.isPending){s("Đang quét mạng LAN, vui lòng chờ lệnh hiện tại hoàn tất...","warning",3e3);return}const p=q.current[y]||0;if(f&&r-p<10*1e3){s("Vui lòng chờ ít nhất 10 giây giữa các lần quét mạng LAN.","warning",2500);return}if(!f&&r-p<30*1e3)return;q.current[y]=r;const o=(h.agents||[]).filter(T=>T.is_agent_active);if(!o||o.length===0){s(`Không có Agent nào trực thuộc mạng LAN ${y} đang hoạt động để thực hiện quét!`,"error",4e3);return}Ur(y).catch(T=>console.warn("[triggerLanScan] purgeLanPrinters error (non-fatal):",T)),o.sort((T,j)=>{const M=new Date(T.last_seen||T.updated_at||T.last_ping||0).getTime();return new Date(j.last_seen||j.updated_at||j.last_ping||0).getTime()-M});const g=o[0];if(g&&l){s("Quét mạng LAN...","info",3e3),(k=t.setCommandStatus)==null||k.call(t,M=>({...M,[`scan_lan_${y}`]:{message:"⏳ Quét mạng LAN...",isPending:!0}}));const T=g,j={command:"force_subnet_scan",lead:h.lead};Ee(`/api/agents/${T.agent_uid}/utility/exec?lead=default`,{method:"POST",body:JSON.stringify(j)}).then(M=>{const ie=(M==null?void 0:M.command_id)||(M==null?void 0:M.id);ie&&(M!=null&&M.skipped&&s(M.message||"Lệnh quét mạng đang được Agent thực thi...","info",3e3),l(Number(ie),`scan_lan_${y}`,async d=>{console.log("🔍 [PRINTAGENT RESULT] Kết quả force_subnet_scan:",d);let Y=[];const z=(d==null?void 0:d.result)||(d==null?void 0:d.result_payload)||(d==null?void 0:d.output)||(d==null?void 0:d.error_message)||(d==null?void 0:d.raw)||"";if(Array.isArray(z))Y=z;else if(typeof z=="string"&&z.trim()){try{const pe=JSON.parse(z.trim());Array.isArray(pe)&&(Y=pe)}catch{}if(Y.length===0)try{let pe="";if(z.includes("__PRINTERS_JSON_START__"))pe=z.split("__PRINTERS_JSON_START__")[1].split("__PRINTERS_JSON_END__")[0].trim();else{const me=z.match(/(?:^|\n)\s*(\[\s*\{[\s\S]*\}\s*\])/);if(me)pe=me[1];else{const Ke=z.match(/(\[\s*\{[\s\S]*\}\s*\])/);Ke&&(pe=Ke[1])}}if(pe){const me=JSON.parse(pe);Array.isArray(me)&&(Y=me)}}catch(pe){console.error("🔍 [Frontend] Lỗi parse JSON máy in:",pe)}}if(Y.length>0){s("Lan scan done!","success",4e3);try{await Ee("/api/new-devices",{method:"POST",body:JSON.stringify({lan_uid:y||"default",devices:Y})})}catch{}D()}else s("Lan scan done!","success",4e3)},async d=>{s("Quét mạng LAN thất bại","error",4e3)},"⏳ Quét mạng LAN..."))}).catch(M=>{console.error(M)})}},[s,l,u]),se=b.useMemo(()=>{if(!x)return[];const h=(U||"").trim().toLowerCase(),f=(x.printers||[]).filter(y=>{const r=(y.printer_name||y.name||"").toLowerCase().trim(),c=(y.ip||y.printer_ip||"").toLowerCase().trim();return!(r.includes("unknown")||r==="unknown printer"||r.includes("pdf")||r.includes("fax")||r.includes("brother")||r.includes("canon lbp")||r.includes("rustdesk")||h&&!(c===h||c.includes(h)||h.includes(".")&&c.endsWith(h)))});return H?[...f].sort((y,r)=>{const c=String(y.id)===H,p=String(r.id)===H;return c&&!p?-1:!c&&p?1:0}):f},[x,U,H]),ae=b.useCallback(h=>{var k;if(!x)return"";const f=String(h||"").trim(),y=f.toUpperCase().replace(/[:-]/g,""),r=(k=x==null?void 0:x.printers)==null?void 0:k.find(T=>{const j=String((T==null?void 0:T.mac_address)||(T==null?void 0:T.mac_id)||(T==null?void 0:T.mac)||"").toUpperCase().replace(/[:-]/g,"");return y&&j===y||T.ip===f||String(T.id)===f}),c=(x.agents||[]).filter(T=>T.is_agent_active),p=((r==null?void 0:r.mac_address)||(r==null?void 0:r.mac_id)||(f.includes(":")?f:"")).toUpperCase().replace(/-/g,":"),o=p&&ee[p]||ee[f]||(r==null?void 0:r.id)&&ee[r.id]||(r==null?void 0:r.ip)&&ee[r.ip];if(o&&c.some(j=>j.agent_uid===o))return o;const g=x.public_ip||x.wan_ip,a=c.find(T=>T.public_ip&&T.public_ip===g||T.wan_ip&&T.wan_ip===g),P=(r!=null&&r.agent_uid?c.find(T=>T.agent_uid===r.agent_uid):null)||a;return P?P.agent_uid:(r==null?void 0:r.agent_uid)||""},[x,ee]),ue=h=>{localStorage.setItem("goxprint_last_viewed_copier_id",h)};return b.useEffect(()=>{if(x){const h={};x.printers.forEach(f=>{const y=(x.agents||[]).filter(a=>a.is_agent_active),r=x.public_ip||x.wan_ip,c=y.find(a=>a.public_ip&&a.public_ip===r||a.wan_ip&&a.wan_ip===r),p=(f.agent_uid?y.find(a=>a.agent_uid===f.agent_uid):null)||c,o=p?p.agent_uid:f.agent_uid||"",g=(f.mac_address||f.mac_id||"").toUpperCase().replace(/-/g,":");g&&(h[g]=o),f.ip&&(h[f.ip]=o),f.id!==void 0&&f.id!==null&&(h[f.id]=o)}),Z(f=>({...h,...f})),A(f=>{const y={...f};return x.printers.forEach(r=>{const c=r.auth_user||r.user||"",p=r.auth_password||r.password||"",o=(r.mac_address||r.mac_id||"").toUpperCase().replace(/-/g,":"),g=o&&y[o]||y[r.id]||r.ip&&y[r.ip],a=(g==null?void 0:g.user)!==void 0?g.user:c,P=(g==null?void 0:g.pass)!==void 0?g.pass:p;o&&(y[o]={user:a,pass:P}),r.ip&&(y[r.ip]={user:a,pass:P}),r.id!==void 0&&r.id!==null&&(y[r.id]={user:a,pass:P})}),y})}},[x]),{lanSites:_,setLanSites:I,selectedPublicIp:N,setSelectedPublicIp:K,filteredLanSites:oe,targetInternalIp:U,setTargetInternalIp:E,selectedLanUid:_e,setSelectedLanUid:X,selectedLan:x,lanSitesLoading:le,setLanSitesLoading:$,fetchLanSitesData:D,triggerLanScan:v,filteredPrinters:se,copierCredentials:m,setCopierCredentials:A,saveAuthLoading:O,setSaveAuthLoading:L,handleSaveAuth:async h=>{const f=String(typeof h=="object"?h.id:h),y=typeof h=="object"&&(h.mac_id||h.mac_address)||"",r=y?y.toUpperCase().replace(/-/g,":"):"",c=typeof h=="object"&&(h.printer_type||h.type)||"",p=r&&m[r]||m[f]||{user:"",pass:""};L(o=>({...o,[f]:!0,...r?{[r]:!0}:{}}));try{const o=await Vn(r||f,p.user,p.pass,r||f,c);if(o.ok){const g=o.command_id||o.id;g&&l?(s("Đã tạo lệnh lưu Auth, đang đợi Agent thực thi và ghi vào đĩa...","info",3e3),l(g,f,a=>{const P=a!=null&&a.error?` (${a.error})`:a!=null&&a.result?` (${a.result})`:"";s(`Đã test đăng nhập thành công và lưu vào database!${P}`,"success",5e3),I(k=>k.map(T=>({...T,printers:T.printers.map(j=>String(j.id)===String(f)||macId&&j.mac_id===macId?{...j,auth_user:p.user,auth_password:p.pass}:j)}))),L(k=>({...k,[f]:!1}))},a=>{s(`Lỗi Agent lưu Auth: ${a}`,"error"),L(P=>({...P,[f]:!1}))},"Đang thực thi lưu tài khoản vào tệp printers.json...")):(s("Đã lưu tài khoản Web UI máy photocopy thành công","success"),I(a=>a.map(P=>({...P,printers:P.printers.map(k=>String(k.id)===String(f)||macId&&k.mac_id===macId?{...k,auth_user:p.user,auth_password:p.pass}:k)}))),L(a=>({...a,[f]:!1})))}else throw new Error(o.error||"Lỗi lưu thông tin đăng nhập")}catch{s("Lưu tài khoản thất bại","error"),L(g=>({...g,[f]:!1}))}},editIpModalData:Te,setEditIpModalData:te,handleEditIP:h=>{const f=ae(h.mac_id||h.mac_address||h.ip||h.id);te({isOpen:!0,copier:h,oldIp:h.ip||"",newIp:h.ip||"",targetAgentUid:f,status:"",error:""})},handleSaveEditIP:async()=>{if(!Te.copier||!Te.newIp)return;const h=Te.copier,f=Te.oldIp,y=Te.newIp.trim(),r=Te.targetAgentUid;if(!y){te(c=>({...c,error:"Vui lòng nhập địa chỉ IP mới!"}));return}te(c=>({...c,status:"⌛ Đang gửi lệnh đổi IP tới Agent...",error:""})),s("Đổi IP...","info",2e3);try{const p=(h.printer_type||h.printer_name||"").toLowerCase().includes("toshiba")?"toshiba_change_ftp":"ricoh_change_ftp",o=await at(r,p,"",{old_ip:f,new_ip:y,printer_ip:f,target_ip:f});if(!o.ok||!o.command_id)throw new Error(o.error||"Không thể tạo lệnh đổi IP");te(g=>({...g,status:"⌛ Agent đang kết nối máy in để thực hiện đổi IP..."})),l&&l(o.command_id,`edit_ip_${h.id}`,g=>{s("Đổi IP","success",3e3),I(a=>a.map(P=>({...P,printers:P.printers.map(k=>String(k.id)===String(h.id)||k.mac_id===h.mac_id?{...k,ip:y}:k)}))),te(a=>({...a,isOpen:!1,status:"",error:""}))},g=>{s("Đổi IP thất bại","error"),te(a=>({...a,status:"",error:g}))},"⏳ Đang cập nhật IP...")}catch(c){te(p=>({...p,status:"",error:c.message||"Lỗi không xác định"})),s("Đổi IP thất bại","error")}},expandedPrinters:w,setExpandedPrinters:Q,selectedTargetAgents:ee,setSelectedTargetAgents:Z,getTargetAgentUid:ae,handleCopierClick:ue,accessDeniedState:ce,setAccessDeniedState:re,liveAddressBooks:xe,setLiveAddressBooks:Ie,myClientIp:we}},Nr=new Set(["get_agent_ip","get_public_ip","view_settings_json","view_printers_json","view_scan_points_json","view_agent_loader_debug","view_stout","view_sterror","dxdiag","printers","clean_temp","scan","ricoh_list_scan","toshiba_list_scan"]),Dr={get_agent_ip:"Địa chỉ IP Local của Agent",get_public_ip:"Địa chỉ IP Public (Internet)",view_settings_json:"Nội dung tệp settings.json",view_printers_json:"Nội dung tệp printers.json",view_scan_points_json:"Nội dung tệp scan_points.json",view_agent_loader_debug:"Nội dung tệp agent_loader_debug.txt",view_stout:"Nội dung tệp stout.txt (1000 dòng cuối)",view_sterror:"Nội dung tệp sterror.txt (1000 dòng cuối)",dxdiag:"Kết quả kiểm tra cấu hình hệ thống (DxDiag)",printers:"Danh sách máy in hệ thống",clean_temp:"Kết quả dọn dẹp thư mục tạm & Driver",scan:"Nội dung thư mục Scan gốc (%TEMP%/GoPrinxAgent/ftp)",ricoh_list_scan:"Danh bạ Scan trên máy photo Ricoh",toshiba_list_scan:"Danh bạ Scan trên máy photo Toshiba"},pi=(t={})=>{const{showToast:s,setViewOutputModal:l,setIpInputModal:u}=t,[_,I]=b.useState([]),[N,K]=b.useState(!1),[_e,X]=b.useState(!1),[U,E]=b.useState(null),[le,$]=b.useState(null),[w,Q]=b.useState(null);b.useEffect(()=>{let q=!0;const H=(w==null?void 0:w.agent_uid)||"default";return K(!0),zr(H).then(F=>{if(!q)return;const D=Array.isArray(F)?F:(F==null?void 0:F.commands)||(F==null?void 0:F.rows)||[];I(D)}).catch(F=>{console.error("Failed to load utility commands:",F)}).finally(()=>{q&&K(!1)}),()=>{q=!1}},[w]);const[m,A]=b.useState(""),[O,L]=b.useState(!1),[ee,Z]=b.useState(""),[xe,Ie]=b.useState("ping 8.8.8.8"),Te=b.useCallback((q,H,F,D,oe)=>{var ue;(ue=t.setCommandStatus)==null||ue.call(t,fe=>({...fe,[H]:{message:oe||"Đang thực thi lệnh...",isPending:!0}}));const x=1500,v=6e4,se=Date.now(),ae=setInterval(async()=>{var de,J,h,f,y;const fe=Date.now()-se;if(fe>v){clearInterval(ae),(de=t.setCommandStatus)==null||de.call(t,r=>({...r,[H]:{message:"Lỗi: Quá thời gian chờ (Timeout 60s)",isPending:!1}})),D&&D("Quá thời gian chờ (Timeout 60s)");return}try{const r=await Nt(q);if(r.ok&&r.status==="success"){clearInterval(ae);const c=r.result?` (${r.result})`:"";(J=t.setCommandStatus)==null||J.call(t,p=>({...p,[H]:{message:`Đã hoàn tất thành công!${c}`,isPending:!1}})),F(r)}else if(r.ok&&r.status==="failed"){clearInterval(ae);const c=r.error||r.error_message||r.result||"Thực thi thất bại";(h=t.setCommandStatus)==null||h.call(t,p=>({...p,[H]:{message:`Lỗi: ${c}`,isPending:!1}})),D&&D(c)}else{const c=r.received_at?`Agent đã nhận lệnh (${Math.round(fe/1e3)}s)...`:`Đang gửi lệnh tới Agent (${Math.round(fe/1e3)}s)...`;(f=t.setCommandStatus)==null||f.call(t,p=>({...p,[H]:{message:c,isPending:!0}}))}}catch(r){clearInterval(ae),(y=t.setCommandStatus)==null||y.call(t,c=>({...c,[H]:{message:`Lỗi kết nối: ${r.message||"Lỗi polling"}`,isPending:!1}})),D&&D(r.message||"Lệnh thực hiện thất bại từ Agent")}},x)},[t]),te=async(q,H,F)=>{try{const D=await Zn(q,10),x=(D.jobs||D.commands||[]).filter(v=>v.status==="pending"&&v.command_type===H);return F?x.some(v=>{const se=v.command_params||{};return Object.keys(F).every(ae=>String(se[ae])===String(F[ae]))}):x.length>0}catch{return!1}},ce=b.useCallback(async q=>{X(!0),Z("");try{const H=await at(q,"view_settings_json","");if(!H.ok||!H.command_id)throw new Error(H.error||"Không thể gửi lệnh xem settings.json");Te(H.command_id,"view_settings",F=>{const D=typeof F.result_payload=="object"&&F.result_payload?JSON.stringify(F.result_payload,null,2):F.result_payload||F.result||"";A(D),X(!1)},F=>{Z(`❌ Không thể nạp settings.json: ${F}`),X(!1)},"⌛ Đang nạp settings.json từ Agent...")}catch(H){Z(`❌ Lỗi nạp cấu hình: ${H.message}`),X(!1)}},[Te]),re=async q=>{if(!q||!m)return;try{JSON.parse(m)}catch(F){Z(`❌ Lỗi định dạng JSON: ${F.message}`);return}L(!0),Z("⌛ Đang gửi cấu hình mới tới Agent...");const H=btoa(unescape(encodeURIComponent(m)));try{const F=(_||[]).find(v=>v.command==="save_settings_json"),D=(F==null?void 0:F.command_content)||"",oe=await at(q,"save_settings_json",D,{base64_content:H});if(!oe.ok||!oe.command_id)throw new Error(oe.error||"Không thể tạo lệnh tiện ích");const x=oe.command_id;Te(x,"save_settings",()=>{Z("✅ Đã lưu và nạp lại cấu hình settings.json thành công!"),L(!1),s&&s("Lưu cấu hình","success")},v=>{Z(`❌ Lỗi lưu cấu hình: ${v}`),L(!1)},"⌛ Agent đang ghi đè tệp settings.json...")}catch(F){Z(`❌ Lỗi gửi lệnh: ${F.message}`),L(!1)}},we=b.useCallback(async(q,H,F,D={})=>{let oe=w,x="",v="",se={};if(typeof q=="string"?(x=q,v=H||x,se=F||{}):(oe=q||w,x=H||"",v=F||x,se=D||{}),!!oe){$(x),E({text:"⌛ Đang gửi lệnh tới Agent...",isError:!1});try{const ae=await ei(oe.agent_uid,v,se);if(!ae.ok||!ae.command_id)throw new Error(ae.error||"Không thể tạo lệnh tiện ích");const ue=ae.command_id,fe=6e4,de=1e3,J=Date.now(),h=setInterval(async()=>{try{const f=Date.now()-J;if(f>fe){clearInterval(h),E({text:"Yêu cầu quá thời gian chờ (60s)",isError:!0}),$(null);return}const y=await Nt(ue);if(y.status==="success")clearInterval(h),E({text:"⚡ Thực hiện lệnh tiện ích thành công!",isError:!1}),$(null);else if(y.status==="failed"||!y.ok)clearInterval(h),E({text:`❌ Thất bại: ${y.error||"Lệnh thất bại từ Agent"}`,isError:!0}),$(null);else{const r=Math.round(f/1e3);y.received_at?E({text:`⚡ Agent đã nhận lệnh - đang mở tiện ích... (${r}s)`,isError:!1}):E({text:`⌛ Đang chuyển lệnh tới Agent... (${r}s)`,isError:!1})}}catch(f){console.error("Error polling utility status:",f)}},de)}catch(ae){console.error(`Failed to trigger ${x}:`,ae),E({text:`Lỗi kết nối hoặc gửi lệnh: ${ae.message}`,isError:!0}),$(null)}}},[w]),S=b.useCallback(async(q,H,F)=>{let D=w,oe="",x="";if(typeof q=="string"?(oe=q,x=H||""):(D=q||w,oe=H||"",x=F||""),!D)return;if(await te(D.agent_uid,"trigger_utility",{action:"exec_utility",command:oe})){s&&s("Lệnh đang chờ xử lý...","info");return}const se=_.find(fe=>fe.command===oe),ae=(se==null?void 0:se.output_modal)!==!1||Nr.has(oe),ue=(se==null?void 0:se.label)||Dr[oe]||oe;if(oe==="change_agent_ip"||oe==="check_scan_ip_match"){const fe=oe==="change_agent_ip",de=(D==null?void 0:D.local_ip)||(D==null?void 0:D.ip)||(D==null?void 0:D.agent_ip)||(D==null?void 0:D.localIp)||"";u&&u({isOpen:!0,title:fe?"🌐 Đổi địa chỉ IP tĩnh":"🔍 Kiểm tra IP khớp Copier",hint:fe?"Nhập địa chỉ IPv4 tĩnh muốn gán cho máy Agent.":"Nhập địa chỉ IP muốn kiểm tra xem copier nào có FTP Scan entry khớp.",value:de,changeAllTo:"",scanStatus:"",error:"",onConfirm:(J,h)=>{const f=x.replace("__TARGET_IP__",J);$(oe),E({text:"⌛ Đang gửi lệnh tới Agent...",isError:!1}),at(D.agent_uid,oe,f,{target_ip:J,ip:J,printer_ip:J,change_all_to:h||""}).then(y=>{if(!y.ok||!y.command_id)throw new Error(y.error||"Không thể tạo lệnh tiện ích");const r=y.command_id,c=6e4,p=Date.now(),o=setInterval(async()=>{try{const g=Date.now()-p;if(g>c){clearInterval(o),E({text:"Yêu cầu quá thời gian chờ (60s)",isError:!0}),$(null);return}const a=await Nt(r);if(a.status==="success"){if(clearInterval(o),ae&&l){const P=typeof a.result_payload=="object"&&a.result_payload?JSON.stringify(a.result_payload,null,2):a.result_payload||a.output||a.error_message||a.error||a.result||"(không có nội dung)";l({isOpen:!0,title:ue,content:P,rawPayload:a.result_payload||a.output||a.error_message||a.result||""})}else E({text:"⚡ Thực hiện lệnh thành công!",isError:!1});$(null),t.fetchLanSitesData&&(t.fetchLanSitesData(!0),setTimeout(()=>t.fetchLanSitesData&&t.fetchLanSitesData(!0),2e3),setTimeout(()=>t.fetchLanSitesData&&t.fetchLanSitesData(!0),5e3))}else if(a.status==="failed"||!a.ok){if(clearInterval(o),l){const P=a.error||typeof a.result_payload=="object"&&a.result_payload?JSON.stringify(a.result_payload,null,2):a.result_payload||a.output||a.error_message||a.result||"(không có nội dung)";l({isOpen:!0,title:ue,content:P,rawPayload:a.result_payload||a.output||a.error_message||a.result||""})}else E({text:`❌ Thất bại: ${a.error||"Lệnh thất bại từ Agent"}`,isError:!0});$(null)}else{const P=Math.round(g/1e3);E({text:`⌛ Agent đang thực hiện lệnh... (${P}s)`,isError:!1})}}catch(g){console.error("Error polling status:",g)}},1e3)}).catch(y=>{E({text:`Lỗi gửi lệnh: ${y.message}`,isError:!0}),$(null)})}});return}if($(oe),E({text:"⌛ Đang gửi lệnh thực thi tới Agent...",isError:!1}),oe==="force_subnet_scan"){const fe=(D==null?void 0:D.lan_uid)||(w==null?void 0:w.lan_uid)||"default";Ur(fe).catch(de=>console.warn("[handleTriggerUtilityExec] purgeLanPrinters error (non-fatal):",de))}try{const fe=await at(D.agent_uid,oe,x);if(!fe.ok||!fe.command_id)throw new Error(fe.error||"Không thể tạo lệnh tiện ích");const de=fe.command_id,J=6e4,h=1e3,f=Date.now(),y=setInterval(async()=>{try{const r=Date.now()-f;if(r>J){clearInterval(y),E({text:"Yêu cầu quá thời gian chờ (60s)",isError:!0}),$(null);return}const c=await Nt(de);if(c.status==="success"){if(clearInterval(y),ae&&l){const p=typeof c.result_payload=="object"&&c.result_payload?JSON.stringify(c.result_payload,null,2):c.result_payload||c.output||c.error_message||c.error||c.result||"(không có nội dung)";l({isOpen:!0,title:ue,content:p,rawPayload:c.result_payload||c.output||c.error_message||c.result||""})}else E({text:"⚡ Thực hiện lệnh thành công!",isError:!1});$(null),t.fetchLanSitesData&&(t.fetchLanSitesData(!0),setTimeout(()=>t.fetchLanSitesData&&t.fetchLanSitesData(!0),2e3))}else if(c.status==="failed"||!c.ok){if(clearInterval(y),ae&&l){const p=c.error||typeof c.result_payload=="object"&&c.result_payload?JSON.stringify(c.result_payload,null,2):c.result_payload||c.output||c.error_message||c.result||"(không có nội dung)";l({isOpen:!0,title:ue,content:p,rawPayload:c.result_payload||c.output||c.error_message||c.result||""})}else E({text:`❌ Thất bại: ${c.error||c.error_message||"Lệnh thất bại từ Agent"}`,isError:!0});$(null)}else{const p=Math.round(r/1e3),o=c.progress_text||`Đang xử lý... (${p}s)`;E({text:`⌛ ${o}`,isError:!1})}}catch(r){const c=(r==null?void 0:r.message)||String(r||"");ae&&l&&(c.startsWith("[PATH]")||c.includes("stout")||c.includes("sterror")||c.includes("settings.json"))?(clearInterval(y),l({isOpen:!0,title:ue,content:c,rawPayload:c}),E(null),$(null)):c.includes("502")||c.includes("404")||c.includes("xóa")||elapsed>15e3?(clearInterval(y),$(null),E({text:"❌ Lệnh đã dừng hoặc bị xóa",isError:!0})):console.error("Poll error:",r)}},h)}catch(fe){E({text:`Lỗi: ${fe.message}`,isError:!0}),$(null)}},[w,_,s,u,l]);return{VIEW_COMMANDS:Nr,VIEW_COMMAND_TITLES:Dr,utilityCommands:_,setUtilityCommands:I,utilityCommandsLoading:N,setUtilityCommandsLoading:K,utilitySettingsLoading:_e,setUtilitySettingsLoading:X,utilityStatusMsg:U,setUtilityStatusMsg:E,utilityActionPending:le,setUtilityActionPending:$,selectedUtilityAgent:w,setSelectedUtilityAgent:Q,editableSettingsText:m,setEditableSettingsText:A,isSavingSettings:O,setIsSavingSettings:L,settingsSaveStatus:ee,setSettingsSaveStatus:Z,customRunCommand:xe,setCustomRunCommand:Ie,pollCommandStatus:Te,loadUtilitySettings:ce,handleSaveSettings:re,handleTriggerUtility:we,handleTriggerUtilityExec:S}},mi=(t={})=>{const{showToast:s,pollCommandStatus:l}=t,[u,_]=b.useState({isOpen:!1,copier:null,url:"",tunnelUrl:"",directUrl:"",auth:{user:"",pass:""}}),[I,N]=b.useState("tunnel"),[K,_e]=b.useState(!1),[X,U]=b.useState([]),[E,le]=b.useState(-1),[$,w]=b.useState(!1),[Q,m]=b.useState(null),A=b.useRef(null),[O,L]=b.useState({isOpen:!1,printerId:"",copier:null,targetAgentUid:"",status:"",error:""}),ee=b.useCallback(()=>{Q&&(URL.revokeObjectURL(Q),m(null)),_(ce=>({...ce,isOpen:!1}))},[Q]),Z=b.useCallback(async(ce,re,we="/")=>{if(!ce){s&&s("Không tìm thấy Agent UID","error");return}const S=(H,F)=>`
    ...
    `,q=window.open("about:blank","_blank");q&&q.document.write(S("Đang kết nối tên miền...",`Đang kết nối đến máy in ${re} qua tên miền *.app.goxprint.com...`)),_e(!0);try{const D=await(await fetch(`https://agentapi.quanlymay.com/api/agents/${ce}/tunnel/start`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({printer_ip:re,printer_port:80})})).json();D.ok&&D.url?q&&(q.location.href=D.url):(q&&q.close(),s&&s("Kết nối lỗi: "+(D.error||"Không thể khởi động đường hầm SSH ngược trên Agent"),"error"))}catch(H){q&&q.close(),s&&s("Lỗi hệ thống VPS: "+(H.message||H),"error")}finally{_e(!1)}},[s]),xe=b.useCallback(()=>{if(E>0){const ce=X[E-1];le(E-1),u.copier&&Z(u.copier.agent_uid,u.copier.ip,ce)}},[E,X,u,Z]),Ie=b.useCallback(()=>{if(E<X.length-1){const ce=X[E+1];le(E+1),u.copier&&Z(u.copier.agent_uid,u.copier.ip,ce)}},[E,X,u,Z]);return{webPreviewModal:u,setWebPreviewModal:_,webPreviewTab:I,setWebPreviewTab:N,webPreviewLoading:K,setWebPreviewLoading:_e,webPreviewHistory:X,setWebPreviewHistory:U,webPreviewHistoryIndex:E,setWebPreviewHistoryIndex:le,showPreviewDetails:$,setShowPreviewDetails:w,previewBlobUrl:Q,setPreviewBlobUrl:m,previewIframeRef:A,handleCloseWebPreview:ee,fetchRemotePage:Z,handleHistoryBack:xe,handleHistoryForward:Ie,installDriverModal:O,setInstallDriverModal:L,handleRemoteInstallDriver:(ce,re,we)=>{L({isOpen:!0,printerId:String(ce),copier:re,targetAgentUid:we,status:"",error:""})},executeRemoteInstallDriver:async()=>{if(!O.copier||!O.targetAgentUid)return;const{printerId:ce,copier:re,targetAgentUid:we}=O;L(S=>({...S,status:"⌛ Đang gửi lệnh cài đặt Driver tới Agent...",error:""})),s&&s("Đang tạo lệnh tải và cài đặt Driver máy in tự động...","info",3e3);try{const S=await Gr(we,re.ip,re.printer_name||re.name||"Printer",re.printer_type||re.brand||"");if(!S.ok||!S.command_id)throw new Error(S.error||"Không thể tạo lệnh cài driver");L(q=>({...q,status:"⌛ Agent đang tải gói Driver và tiến hành Silent Install..."})),l&&l(S.command_id,`install_driver_${ce}`,q=>{s&&s("✓ Đã cài đặt Driver máy in thành công lên máy Agent!","success",5e3),L(H=>({...H,isOpen:!1,status:"",error:""}))},q=>{s&&s(`[-] Lỗi cài đặt Driver: ${q}`,"error"),L(H=>({...H,status:"",error:q}))},"⏳ Agent đang cài đặt Driver vào hệ thống Windows...")}catch(S){L(q=>({...q,status:"",error:S.message||"Lỗi không xác định"})),s&&s(`Lỗi cài đặt Driver: ${S.message}`,"error")}}}},ui=(t={})=>{const{showToast:s,pollCommandStatus:l,setViewOutputModal:u}=t,[_,I]=b.useState({isOpen:!1,agentUid:"",agentName:"",currentPath:"",items:[],loading:!1,error:""}),[N,K]=b.useState([]),[_e,X]=b.useState(!1),[U,E]=b.useState({isOpen:!1,printer:null,data:null,rawJson:""}),le=(Q,m)=>{if(!m||m===".")return Q;if(m===".."){const A=Q.split("/").filter(Boolean);return A.pop(),A.join("/")||""}return Q?`${Q}/${m}`:m},$=b.useCallback(async(Q,m,A="")=>{I({isOpen:!0,agentUid:Q,agentName:m,currentPath:A,items:[],loading:!0,error:""});try{const O=await Br(Q,A);if(O.ok)I(L=>({...L,items:O.items||O.files||[],loading:!1}));else throw new Error(O.error||"Không thể tải danh sách tệp")}catch(O){I(L=>({...L,loading:!1,error:O.message||"Lỗi kết nối tới Agent"})),s&&s(`Không thể mở thư mục lưu trữ: ${O.message}`,"error")}},[s]),w=b.useCallback(async(Q,m)=>{if(Q){s&&s("⌛ Đang tải file scan_points.json từ Agent...","info",3e3);try{const A=await at(Q,"view_scan_points_json","");if(!A.ok||!A.command_id)throw new Error(A.error||"Không thể tạo lệnh xem file scan_points.json");l&&l(A.command_id,`view_scan_points_${(m==null?void 0:m.id)||"json"}`,O=>{const L=O.result_payload||O.result||"";let ee=null;if(typeof L=="object"&&L!==null)ee=L;else if(typeof L=="string")try{ee=JSON.parse(L)}catch{ee=null}const Z=ee?JSON.stringify(ee,null,2):String(L);E({isOpen:!0,printer:m,data:ee,rawJson:Z}),u&&u({isOpen:!0,title:`📋 Danh bạ Scan (${(m==null?void 0:m.printer_name)||(m==null?void 0:m.name)||"Copier"})`,content:Z,rawPayload:L})},O=>{s&&s(`Lỗi xem scan_points.json: ${O}`,"error")},"⏳ Agent đang đọc file scan_points.json...")}catch(A){s&&s(`Lỗi đọc file scan_points.json: ${A.message}`,"error")}}},[s,l,u]);return{storageModalData:_,setStorageModalData:I,storageFiles:N,setStorageFiles:K,storageLoading:_e,setStorageLoading:X,handleOpenStorageFiles:$,resolveRelativePath:le,scanPointsViewerModal:U,setScanPointsViewerModal:E,handleViewScanPointsJson:w}},gi=(t={})=>{const[s,l]=b.useState([]),u=se=>{const ae=String(se||"").trim().split(/\s+/);return ae.length>15?ae.slice(0,15).join(" ")+"…":String(se||"").trim()},_=b.useCallback((se,ae="info",ue=3e3)=>{const fe=Date.now().toString()+Math.random().toString().slice(2,6),de=u(se);l(J=>[...J,{id:fe,message:de,type:ae}]),setTimeout(()=>{l(J=>J.filter(h=>h.id!==fe))},ue)},[]),I=b.useCallback((se,ae,ue="info",fe=5e3)=>{const de=u(ae);l(J=>{const h=J.findIndex(f=>f.id===se);if(h!==-1){const f=[...J];return f[h]={id:se,message:de,type:ue},f}return[...J,{id:se,message:de,type:ue}]}),setTimeout(()=>{l(J=>J.filter(h=>h.id!==se))},fe)},[]),[N,K]=b.useState("copiers"),[_e,X]=b.useState({}),[U,E]=b.useState(null),[le,$]=b.useState({isOpen:!1,title:"",message:""}),[w,Q]=b.useState({isOpen:!1,printerId:"",entry:null,agentUid:""}),[m,A]=b.useState({isOpen:!1,title:"",content:"",rawPayload:null}),[O,L]=b.useState({isOpen:!1,title:"",hint:"",value:"",changeAllTo:"",scanStatus:"",error:""}),[ee,Z]=b.useState({printerId:"",name:"",email:"",agentUid:""}),[xe,Ie]=b.useState(!1),[Te,te]=b.useState({lanUid:"",agentUid:"",email:""}),[ce,re]=b.useState(!1),[we,S]=b.useState(null),[q,H]=b.useState({}),F=b.useRef(null),D=di({showToast:_,pollCommandStatus:(...se)=>{var ae;return(ae=F.current)==null?void 0:ae.call(F,...se)},utilityCommands:[],activeTab:N}),oe=pi({showToast:_,setViewOutputModal:A,setIpInputModal:L,setCommandStatus:X,fetchLanSitesData:D.fetchLanSitesData});F.current=oe.pollCommandStatus;const x=mi({showToast:_,pollCommandStatus:oe.pollCommandStatus}),v=ui({showToast:_,pollCommandStatus:oe.pollCommandStatus,setViewOutputModal:A});return{toasts:s,setToasts:l,showToast:_,replaceToast:I,activeTab:N,setActiveTab:K,commandStatus:_e,setCommandStatus:X,activeModal:U,setActiveModal:E,confirmModal:le,setConfirmModal:$,deleteScanPointModal:w,setDeleteScanPointModal:Q,viewOutputModal:m,setViewOutputModal:A,ipInputModal:O,setIpInputModal:L,publicFtpData:ee,setPublicFtpData:Z,publicFtpLoading:xe,setPublicFtpLoading:Ie,privateFtpData:Te,setPrivateFtpData:te,privateFtpLoading:ce,setPrivateFtpLoading:re,emailFileCounts:q,setEmailFileCounts:H,getDestinationStatus:()=>({label:"✔ ACTIVE",type:"success",title:""}),getDestinationStatusHtml:()=>({label:"✔ ACTIVE",type:"success",title:""}),...D,...oe,...x,...v}},Lt="https://agentapi.quanlymay.com",hi=(t={})=>{const{cameraForm:s,cameras:l,customRecordDuration:u,directLan:_,fetchCameraFiles:I,fetchCameraStatus:N,fetchCameras:K,isRecording30s:_e,setActiveModal:X,setAllocatedVncAddr:U,setCameraTestLoading:E,setCameraTestResult:le,setIsRecording30s:$,setRecording30sCountdown:w,setSelectedCamera:Q,setToshibaVncData:m,setVncTunnelLoading:A,showToast:O}=t;return{cameraForm:s,cameras:l,customRecordDuration:u,directLan:_,fetchCameraFiles:I,fetchCameraStatus:N,fetchCameras:K,handleDeleteCamera:async(te,ce)=>{if(window.confirm("Bạn có chắc chắn muốn xóa cấu hình camera này?"))try{(await(await fetch(`${Lt}/api/agents/${te}/cameras/${ce}/delete`,{method:"POST"})).json()).ok?(O("Xóa camera","success"),K(te),Q(null)):O("Xóa camera thất bại","error")}catch{O("Xóa camera thất bại","error")}},handleDeleteCameraFile:async(te,ce,re)=>{if(window.confirm(`Bạn có chắc chắn muốn xóa tệp video này khỏi máy trạm?
File: ${re}`))try{const S=await(await fetch(`${Lt}/api/agents/${te}/cameras/${ce}/delete-file`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({filename:re})})).json();S.ok?(O("Đã xóa tệp video thành công!","success"),I(te,ce)):O("Lỗi xóa tệp: "+S.error,"error")}catch(we){O("Lỗi hệ thống: "+we.message,"error")}},handleRecord30s:async(te,ce)=>{if(_e)return;const re=l.find(H=>H.id===ce),we=(re==null?void 0:re.mac_address)||"";if(!we){O("Không có MAC ID","error");return}$(!0),w(u);let S=u;const q=setInterval(()=>{S-=1,w(Math.max(S,0)),S<=0&&clearInterval(q)},1e3);try{O(`Ghi hình ${u}s...`,"info",2e3);const F=await(await fetch(`${Lt}/api/cameras/record-control`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mac_id:we,action:"record",duration:u})})).json();clearInterval(q),F.ok?O(`Ghi hình ${u}s`,"success"):O("Ghi hình thất bại","error")}catch{clearInterval(q),O("Ghi hình thất bại","error")}finally{$(!1),setTimeout(()=>{N(te,ce),I(te,ce)},1500)}},handleSaveCameraConfig:async te=>{try{(await(await fetch(`${Lt}/api/agents/${te}/cameras`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)})).json()).ok?(O("Lưu camera","success"),K(te),Q(null)):O("Lưu camera thất bại","error")}catch{O("Lưu camera thất bại","error")}},handleStartToshibaVnc:async(te,ce,re)=>{if(m({ip:te,printerName:ce,agentUid:re}),U(""),X("toshiba_vnc"),_){U(`${te}:49105`);return}A(!0);try{const S=await(await fetch(`${Lt}/api/agents/${re}/tunnel/start`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({printer_ip:te,printer_port:49105})})).json();if(S.ok&&S.url_port){const q=S.url_port.replace("http://","").replace("https://","");U(q)}else O("Không thể mở đường hầm VNC: "+(S.error||"Lỗi không xác định"),"error"),X(null)}catch(we){O("Lỗi kết nối VPS: "+(we.message||we),"error"),X(null)}finally{A(!1)}},handleTestCameraConnection:async te=>{E(!0),le(null);try{const re=await(await fetch(`${Lt}/api/agents/${te}/cameras/0/test`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({rtsp_url:s.rtsp_url})})).json();re.ok&&re.result?le(re.result):le({ok:!1,msg:re.error||"Lỗi kiểm tra kết nối"})}catch(ce){le({ok:!1,msg:"Lỗi: "+ce.message})}finally{E(!1)}},isRecording30s:_e,setActiveModal:X,setAllocatedVncAddr:U,setCameraTestLoading:E,setCameraTestResult:le,setIsRecording30s:$,setRecording30sCountdown:w,setSelectedCamera:Q,setToshibaVncData:m,setVncTunnelLoading:A,showToast:O}},fi={ricoh_create_scan:`import requests
import re
import base64
import json
import time
...
if __name__ == "__main__":
    main()
`},_i="https://agentapi.quanlymay.com";function Mr(t,s,l){const u=t.email_address||t.email||"",_=t.physical_path||t.folder||t.folder_path||"",I=(u||_||"").trim();if(!I)return{label:"UNKNOWN",type:"error",title:""};if(t.type==="Email"||u.includes("@"))return{label:"✔ ACTIVE",type:"success",title:""};const K=(s||[]).find(U=>(U.email||"").toLowerCase().trim()===I.toLowerCase().trim()),_e=K?K.email_number:Number(t.registration_no);if(!_e||isNaN(_e))return{label:"✔ ACTIVE",type:"success",title:""};const X=(l||[]).find(U=>U.is_master&&U.is_agent_active)||(l||[]).find(U=>U.is_agent_active)||(l||[])[0];if(X){const U=(X.ftp_sites||[]).find(E=>Number(E.port)===Number(_e));if(U){const E=("C:/Scangox/"+I).toLowerCase().replace(/\\/g,"/"),$=(U.path||"").toLowerCase().replace(/\\/g,"/")===E;return U.running&&$?{label:"✔ OK",type:"success",title:""}:U.running&&!$?{label:"⚠ CONFLICT",type:"warning",title:`FTP site uses folder: ${U.path} instead of expected: C:/Scangox/${I}`}:U.error&&(U.error.toLowerCase().includes("in use")||U.error.toLowerCase().includes("busy")||U.error.toLowerCase().includes("already bound")||U.error.toLowerCase().includes("already in use"))?{label:"❌ PORT BUSY",type:"error",title:U.error}:{label:"❌ FAILED",type:"error",title:U.error||"FTP site failed to start"}}else return{label:"PENDING SETUP",type:"warning",title:""}}else return{label:"OFFLINE",type:"neutral",title:""}}function vt(t,s){if(!Array.isArray(t)||!s)return;const l=String(typeof s=="object"?s.mac_id||s.mac_address||s.mac||s.ip||s.id:s).trim(),u=l.toUpperCase().replace(/[:-]/g,"");if(u.length===12&&/^[0-9A-F]{12}$/.test(u)){const _=t.find(I=>String((I==null?void 0:I.mac_address)||(I==null?void 0:I.mac_id)||(I==null?void 0:I.mac)||"").toUpperCase().replace(/[:-]/g,"")===u);if(_)return _}if(l.includes(".")){const _=t.find(I=>String((I==null?void 0:I.ip)||(I==null?void 0:I.printer_ip)||"")===l);if(_)return _}return t.find(_=>String(_==null?void 0:_.id)===l||String((_==null?void 0:_.mac_id)||"").toUpperCase()===l.toUpperCase()||String((_==null?void 0:_.mac_address)||"").toUpperCase()===l.toUpperCase()||String((_==null?void 0:_.ip)||"")===l)}const xi=(t={})=>{const{activeAgentUid:s,cameras:l,copierCredentials:u={},deleteScanPointModal:_,editIpModalData:I,fetchLanSitesData:N,getTargetAgentUid:K,isDuplicatePending:_e,lanSites:X=[],pollCommandStatus:U,queryDuration:E,queryTimestamp:le,replaceToast:$,saveScanPointToDb:w,selectedCamera:Q,selectedLan:m,setActiveModal:A,setDeleteScanPointModal:O,setEditIpModalData:L,setInstallDriverModal:ee,setLiveAddressBooks:Z,setQueriedVideoUrl:xe,setQueryDuration:Ie,setQueryTimestamp:Te,setQueryVideoLoading:te,setStorageFiles:ce,setStorageLoading:re,setStorageModalData:we,showToast:S,utilityCommands:q=[]}=t,H=async r=>{const c=String((r==null?void 0:r.mac_address)||(r==null?void 0:r.mac_id)||(r==null?void 0:r.mac)||"").trim(),p=String((r==null?void 0:r.ip)||(r==null?void 0:r.printer_ip)||(typeof r=="string"?r:"")||"").trim(),o=c.toUpperCase().replace(/[^0-9A-F:]/g,""),g=o.replace(/[:-]/g,"");let a="",P="";try{const k=await Ee(`/api/devices/credentials-map?t=${Date.now()}`);if(k&&k.ok&&k.credentials){const T=k.credentials,j=o&&T[o]||g&&T[g]||o&&T[o.replace(/:/g,"-")]||p&&T[p];j&&(a=String(j.user||j.auth_user||"").trim(),P=String(j.password||j.auth_password||j.pass||"").trim())}}catch(k){throw new Error(`❌ Lỗi kết nối VPS khi tải tài khoản máy in: ${k.message||"Lỗi mạng"}`)}if(!a){const k=o||p||"chưa xác định";throw new Error(`⚠️ Chưa có Tài khoản Web máy in (admin) trong bảng PrinterAuthCredential trên VPS cho thiết bị (MAC/IP: ${k}). Vui lòng nhập User/Pass và bấm "Lưu Auth" trước!`)}return{user:a,pass:P,mac:o||p}},F=async(r,c,p,o)=>{var T;const g=p||le,a=o||E;if(!g)return;const P=((T=l.find(j=>j.id===c))==null?void 0:T.name)||"";if(await _e(r,"trigger_utility",{action:"query_camera_video",camera_name:P,timestamp:g,duration:a})){S("Đang chờ video...","info");return}te(!0),xe("");try{if((await(await fetch(`${_i}/api/agents/${r}/cameras/${c}/query-video`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({timestamp:g,duration:a})})).json()).ok){const ie=g.replace(/[- :]/g,""),d=ie.substring(0,8)+"_"+ie.substring(8,14);xe(`clip_${Q.camera_name}_${d}.mp4`)}else S("Truy xuất thất bại","error")}catch{S("Truy xuất thất bại","error")}finally{te(!1)}},D=r=>{const c=r.match(/_(\d{8}_\d{6})\.mp4$/);if(c){const p=c[1],o=`${p.substring(0,4)}-${p.substring(4,6)}-${p.substring(6,8)} ${p.substring(9,11)}:${p.substring(11,13)}:${p.substring(13,15)}`;Te(o),Ie(60),F(s,Q.id,o,60),setTimeout(()=>{var g;(g=document.getElementById("video-playback-card"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},100)}else S("Không parse được thời gian từ tên tệp","error")},oe=(r,c)=>{var j;const p=(X||[]).flatMap(M=>M.printers||[]),o=typeof r=="object"&&r!==null?r:vt(p,r),g=((o==null?void 0:o.mac_address)||(o==null?void 0:o.mac_id)||(typeof r=="string"&&(r.includes(":")||r.includes("-"))?r:"")).toUpperCase().replace(/-/g,":"),a=((o==null?void 0:o.ip)||(o==null?void 0:o.printer_ip)||(typeof r=="string"&&r.includes(".")?r:"")).trim();if(!a||a==="0.0.0.0"){S(`Không tìm thấy IP hợp lệ của máy in (${g||(typeof r=="string"?r:"")})!`,"error");return}const P=(m==null?void 0:m.public_ip)||(m==null?void 0:m.wan_ip),k=(j=((m==null?void 0:m.agents)||[]).find(M=>M.is_agent_active&&(M.public_ip&&M.public_ip===P||M.wan_ip&&M.wan_ip===P)))==null?void 0:j.agent_uid,T=K(g||(typeof r=="string"?r:""))||(o==null?void 0:o.agent_uid)||k||"";O({isOpen:!0,printerId:g||(typeof r=="string"?r:(o==null?void 0:o.id)||""),printerObj:o,entry:c,agentUid:T})},x=async()=>{var M;const{printerId:r,printerObj:c,entry:p,agentUid:o}=_;if(!p)return;O(ie=>({...ie,isOpen:!1}));const g=p.email_address||p.email||"",a=p.physical_path||p.folder||p.folder_path||"",P=(g||a||"").trim(),k=String(p.registration_no&&p.registration_no!=="-"?p.registration_no:p.entry_id||"").trim(),j=((m==null?void 0:m.emails)||[]).find(ie=>ie.email.toLowerCase().trim()===P.toLowerCase().trim());if(j&&j.id){S("Đang xóa điểm scan private khỏi LAN...","info",3e3);try{const ie=await Yn(j.id);if(ie.ok)S("Đã xóa thành công!","success"),await N();else throw new Error(ie.error||"Không thể xóa")}catch(ie){S(`Lỗi xóa: ${ie.message}`,"error")}return}S("Gửi lệnh xóa điểm scan trên máy photocopy...","info",3e3);try{const ie=(X||[]).flatMap(B=>B.printers||[]),d=c||vt(ie,r),Y=((d==null?void 0:d.mac_address)||(d==null?void 0:d.mac_id)||(r.includes(":")||r.includes("-")?r:"")).toUpperCase().replace(/-/g,":"),z=((d==null?void 0:d.ip)||(d==null?void 0:d.printer_ip)||(r.includes(".")?r:"")).trim();if(!z||z==="0.0.0.0"){S(`Không tìm thấy IP hợp lệ của máy in ${Y||r}!`,"error");return}const pe=((d==null?void 0:d.printer_type)||(d==null?void 0:d.printer_name)||(d==null?void 0:d.brand)||"").toLowerCase().includes("toshiba")||Y.startsWith("00:80:91"),me=pe?"toshiba_delete_scan":"ricoh_delete_scan",Ke=(q||[]).find(B=>B.command===me),tt=(m==null?void 0:m.public_ip)||(m==null?void 0:m.wan_ip),rt=(M=((m==null?void 0:m.agents)||[]).find(B=>B.is_agent_active&&(B.public_ip&&B.public_ip===tt||B.wan_ip&&B.wan_ip===tt)))==null?void 0:M.agent_uid,C=o||K(Y||r)||(d==null?void 0:d.agent_uid)||rt||"";let ne;if(C){let B=Ke;if(!B)try{B=(await zr(C)||[]).find(ze=>ze.command===me)}catch{}const{user:G,pass:W}=await H(d||{mac_address:Y,ip:z});if(!G){S(`Chưa có tài khoản Web Admin của máy in ${Y||z}!`,"error");return}const Ce=String((p==null?void 0:p.entry_id)||(p==null?void 0:p.id)||k||"").trim();if(!Ce||Ce==="null"){S("Không xác định được ID mục danh bạ cần xóa!","error");return}let ve=(B==null?void 0:B.command_content)||fi[me]||"";if(!ve){S(`Lỗi: Không tìm thấy mẫu lệnh thực thi '${me}' trên hệ thống VPS!`,"error");return}ve=ve.replace(/__TARGET_IP__/g,z),ve=ve.replace(/__TARGET_USER__/g,G),ve=ve.replace(/__TARGET_PASS__/g,W||""),ve=ve.replace(/__TARGET_ID__/g,Ce),ve=ve.replace(/__TARGET_SCAN_USER__/g,(p==null?void 0:p.name)||""),ne=await at(C,me,ve,{printer_ip:z,ip:z,mac_id:Y,mac_address:Y,auth_user:G,auth_password:W,target_id:Ce,entry_id:Ce,registration_no:k})}else ne=await ri(Y||z||r,k,p.entry_id||"",o||void 0,{printer_ip:z,ip:z,mac_id:Y,mac_address:Y});if(!ne.ok||!ne.command_id)throw new Error(ne.error||"Không thể tạo lệnh xóa");U(ne.command_id,Y||z||r,async B=>{S("Xóa điểm scan thành công","success"),console.log("Finish delete scan point, updating address book state directly",B);const G=(d==null?void 0:d.mac_address)||(d==null?void 0:d.mac_id)||Y,W=G?String(G).toUpperCase().replace(/-/g,":"):Y,Ce=d!=null&&d.id?String(d.id):String(r),ve=z;let je=(B==null?void 0:B.address_book_sync)||(B==null?void 0:B.address_book_data);if(!je&&(B!=null&&B.result||B!=null&&B.result_payload)){const Fe=String(B.result||B.result_payload||"").trim();if(Fe.includes("__ADDRESS_BOOK_JSON_START__"))try{let He=Fe.split("__ADDRESS_BOOK_JSON_START__")[1].split("__ADDRESS_BOOK_JSON_END__")[0].trim();He=He.replace(/^(\n|\r|\\n|\\r)+|(\n|\r|\\n|\\r)+$/g,"").trim(),je=JSON.parse(He)}catch{}else if(Fe.startsWith("{")&&Fe.includes('"address_list"'))try{je=JSON.parse(Fe)}catch{}}je&&typeof Z=="function"&&Z(Fe=>{const He={...Fe};return W&&(He[W]=je),Ce&&(He[Ce]=je),ve&&(He[ve]=je),He});const ze={...d||{},id:r,ip:z,printer_ip:z,mac_address:Y,mac_id:Y,printer_name:(d==null?void 0:d.printer_name)||(d==null?void 0:d.name)||"Photocopy",printer_type:pe?"toshiba":"ricoh",brand:pe?"toshiba":"ricoh",agent_uid:C||(d==null?void 0:d.agent_uid)||o||s||""};de(ze)},B=>{S(`Xóa điểm scan thất bại: ${B||"Agent không phản hồi"}`,"error")},"⏳ Xóa điểm scan...")}catch(ie){S(`Xóa điểm scan thất bại: ${ie.message||"Lỗi không xác định"}`,"error")}},v=(r,c)=>{const p=(X||[]).flatMap(M=>M.printers||[]),o=typeof r=="object"&&r!==null?r:vt(p,r),g=c.folder||c.physical_path||c.folder_path||"";let a="",P="2130";const k=g.match(/^ftp:\/\/([^:/]+)(?::(\d+))?(.*)$/i),T=g.match(/^\\\\([^\\]+)(.*)$/);if(k)a=k[1],P=k[2]||"2130";else if(T)a=T[1],P="";else{const M=g.match(/^([^:/]+)(?::(\d+))?(.*)$/);M&&!g.startsWith("\\\\")&&(a=M[1],P=M[2]||"2130")}const j=a?P?`${a}:${P}`:a:"192.168.1.100:2130";L({printerId:(o==null?void 0:o.mac_address)||(o==null?void 0:o.mac_id)||(typeof r=="string"?r:(o==null?void 0:o.id)||""),printerObj:o,entry:c,currentIp:a,newIp:j,newPort:P||"2130"}),A("edit_ip")},se=async()=>{if(!I)return;const{printerId:r,printerObj:c,entry:p,newIp:o,newPort:g}=I,a=p.folder||p.physical_path||p.folder_path||"",P=a.match(/^ftp:\/\/([^:/]+)(?::(\d+))?(.*)$/i),k=a.match(/^\\\\([^\\]+)(.*)$/);let T=o.trim();if((g||"2130").trim(),T.includes(":")){const ie=T.split(":");T=ie[0].trim(),ie[1].trim()}if(P)P[3];else if(k)k[2];else{const ie=a.match(/^([^:/]+)(?::(\d+))?(.*)$/);ie&&!a.startsWith("\\\\")&&ie[3]}const j=p.registration_no;A(null),S("Đổi IP điểm scan...","info",2e3);let M="";if(P)M=P[1];else if(k)M=k[1];else{const ie=a.match(/^([^:/]+)/);ie&&!a.startsWith("\\\\")&&(M=ie[1])}M||(M=T);try{const ie=(X||[]).flatMap(W=>W.printers||[]),d=c||vt(ie,r)||vt((m==null?void 0:m.printers)||[],r),Y=(d==null?void 0:d.mac_address)||(d==null?void 0:d.mac_id)||(r.includes(":")?r:""),z=Y?String(Y).toUpperCase().replace(/-/g,":"):"",pe=((d==null?void 0:d.ip)||(d==null?void 0:d.printer_ip)||(r.includes(".")?r:"")).trim();if(!pe||pe==="0.0.0.0")throw new Error(`Thiếu IP máy in hợp lệ cho ${z||r}!`);const me=K(z||r)||(d==null?void 0:d.agent_uid)||"",Ke=z&&u[z]||u[r]||{},tt=Ke.user||(d==null?void 0:d.auth_user)||(d==null?void 0:d.username),rt=Ke.pass||(d==null?void 0:d.auth_password)||(d==null?void 0:d.password)||"";if(!tt)throw new Error(`Chưa có tài khoản Web Admin của máy in ${z||pe}`);const B=String((d==null?void 0:d.printer_type)||(d==null?void 0:d.type)||(d==null?void 0:d.brand)||"").toLowerCase().includes("toshiba")||z.startsWith("00:80:91")?"toshiba_change_ftp":"ricoh_change_ftp",G=await at(me,B,"",{printer_ip:pe,ip:pe,mac_id:z,mac_address:z,auth_user:tt,auth_password:rt,target_id:j,target_name:p.name,old_ip:M,new_ip:T});if(!G.ok||!G.command_id)throw new Error(G.error||"Lỗi đổi IP");U(G.command_id,z||r,async W=>{S("Đổi IP điểm scan","success");const Ce=(d==null?void 0:d.mac_address)||(d==null?void 0:d.mac_id)||r,ve=Ce?String(Ce).toUpperCase().replace(/-/g,":"):"";let je=(W==null?void 0:W.address_book_sync)||(W==null?void 0:W.address_book_data);if(!je&&(W!=null&&W.result||W!=null&&W.result_payload)){const ze=String(W.result||W.result_payload||"");if(ze.includes("__ADDRESS_BOOK_JSON_START__"))try{let Fe=ze.split("__ADDRESS_BOOK_JSON_START__")[1].split("__ADDRESS_BOOK_JSON_END__")[0].trim();Fe=Fe.replace(/^(\n|\r|\\n|\\r)+|(\n|\r|\\n|\\r)+$/g,"").trim(),je=JSON.parse(Fe)}catch{}}ve&&je&&typeof Z=="function"&&Z(ze=>({...ze,[ve]:je})),de&&de(d||r)},W=>{S("Đổi IP thất bại","error")},"⏳ Đổi IP điểm scan...")}catch(ie){S(`Đổi IP thất bại: ${ie.message||""}`,"error")}},ae=async(r,c)=>{we({lanUid:r,email:c}),re(!0),ce([]),A("storage");try{const p=await Br(r,c);if(p.ok)ce(p.rows||[]);else throw new Error(p.error||"Lỗi server")}catch(p){S(`Không thể lấy tệp đã scan: ${p.message}`,"error")}finally{re(!1)}},ue=(r,c,p,o,g,a,P,k)=>{let T=o,j=g,M=c,ie=p;const d=a&&Array.isArray(a)?a:[];if((!j||!T)&&d.length>0){const me=d[0];me&&me.drivers&&me.drivers.length>0&&(T=me.drivers[0].name,j=me.drivers[0].url,M=me.brand||c,ie=me.model||p)}const Y=((m==null?void 0:m.agents)||[]).filter(me=>me.is_agent_active),z=K(r);let pe=[];z&&Y.some(me=>me.agent_uid===z)?pe=[z]:Y.length>0&&(pe=Y.map(me=>me.agent_uid)),ee({isOpen:!0,printerId:r,printerIp:P||(r.includes(".")?r:""),macId:k||(r.includes(":")?r:""),brand:M,model:ie,driverName:T,driverUrl:j,suggestedDrivers:d,selectedAgentUids:pe})},fe=r=>{if(r===0)return"0 Bytes";const c=1024,p=["Bytes","KB","MB","GB"],o=Math.floor(Math.log(r)/Math.log(c));return parseFloat((r/Math.pow(c,o)).toFixed(1))+" "+p[o]},de=async(r,c)=>{const p=(X||[]).flatMap(j=>j.printers||[]),o=typeof r=="object"&&r!==null?r:vt(p,r);let g=((o==null?void 0:o.mac_address)||(o==null?void 0:o.mac_id)||(typeof r=="string"&&(r.includes(":")||r.includes("-"))?r:"")).toUpperCase().replace(/-/g,":"),a=((o==null?void 0:o.ip)||(o==null?void 0:o.printer_ip)||(typeof r=="string"&&r.includes(".")?r:"")).trim(),P=(o==null?void 0:o.printer_name)||(o==null?void 0:o.name)||"",k=String((o==null?void 0:o.id)||(typeof r=="string"?r:g||a));if((!a||!g)&&k){const j=vt(p,k);j&&(g||(g=(j.mac_address||j.mac_id||"").toUpperCase().replace(/-/g,":")),a||(a=(j.ip||j.printer_ip||"").trim()),P||(P=j.printer_name||j.name||""))}if(!a||a==="0.0.0.0"){const j=`❌ Không thể đọc danh bạ: Không tìm thấy IP hợp lệ cho máy in (${g||k})!`;S&&S(j,"error"),console.error(j,{printerTarget:r,printerObj:o,pMacNorm:g,pIp:a});return}const T=c||(o==null?void 0:o.agent_uid)||(o!=null&&o.id&&K?K(o.id):"")||(K?K(g||k):"")||agentUid||s||"";S&&S("Đọc danh bạ...","info",2e3),typeof Z=="function"&&Z(j=>{const M={...j};return k&&delete M[k],g&&delete M[g],a&&delete M[a],M}),t.setCommandStatus&&t.setCommandStatus(j=>{const M={...j};return k&&delete M[k],g&&delete M[g],a&&delete M[a],M}),g&&Jn(g).catch(j=>console.warn("[handleRefetchAddressBook] clearScanPoint error (non-fatal):",j));try{const{user:j,pass:M}=await H(o||{ip:a,mac_address:g}),ie={auth_user:j,auth_password:M,printer_ip:a,ip:a,mac_id:g,mac_address:g};P&&(ie.printer_name=P,ie.name=P),(o!=null&&o.printer_type||o!=null&&o.brand)&&(ie.printer_type=o.printer_type||o.brand,ie.brand=o.printer_type||o.brand);const d=await Kn(g||a||k,T||void 0,ie);if(!d.ok||!d.command_id)throw new Error(d.error||"Không thể tạo lệnh đọc danh bạ");U&&U(d.command_id,g||a||k,async Y=>{let z=(Y==null?void 0:Y.address_book_sync)||(Y==null?void 0:Y.address_book_data)||(Y==null?void 0:Y.result);if(!z&&typeof(Y==null?void 0:Y.result_payload)=="string"){const pe=Y.result_payload;if(pe.includes("__ADDRESS_BOOK_JSON_START__"))try{const me=pe.split("__ADDRESS_BOOK_JSON_START__")[1].split("__ADDRESS_BOOK_JSON_END__")[0].trim();z=JSON.parse(me)}catch{}if(!z){const me=pe.match(/(\{\s*"status"[\s\S]*"address_list"[\s\S]*\})/);if(me)try{z=JSON.parse(me[1])}catch{}}}if(console.log("=================================================="),console.log(`[FRONTEND] KẾT QUẢ ĐỒNG BỘ DANH BẠ MÁY IN (Command ID #${d.command_id}):`,Y),console.log(`[FRONTEND] CHI TIẾT DANH BẠ (Count: ${(z==null?void 0:z.count)||0}):`,(z==null?void 0:z.address_list)||z),console.log("=================================================="),(z==null?void 0:z.status)==="error"){S&&S("Đọc danh bạ thất bại","error");return}S&&S("Đọc danh bạ","success"),z&&(Z&&Z(pe=>{const me={...pe};return k&&(me[k]=z),g&&(me[g]=z),a&&(me[a]=z),me}),g&&Ee("/api/scan-points/save",{method:"POST",body:JSON.stringify({mac_id:g,printer_name:P||"Photocopy",ip:a,agent_uid:T||agentUid||s||"",address_book_data:z})}).catch(pe=>console.error("Failed to post scan points to VPS DB:",pe)),t.setCommandStatus&&t.setCommandStatus(pe=>({...pe,[k]:{...pe[k]||{},address_book_sync:z,isPending:!1},...g?{[g]:{...pe[g]||{},address_book_sync:z,isPending:!1}}:{}})))},Y=>{console.error(`[FRONTEND LỖI ĐỒNG BỘ DANH BẠ] Command ID #${d.command_id}:`,Y),S&&S(`Lỗi đọc danh bạ: ${Y}`,"error")},"⌛ Agent đang đọc danh bạ máy in...")}catch(j){S&&S(`Lỗi gửi lệnh đọc danh bạ: ${j.message}`,"error")}},J=async()=>{const{printerId:r,printerObj:c,name:p,email:o,agentUid:g}=t.publicFtpData||{};if(!p||!p.trim()){S&&S("Vui lòng nhập tên điểm scan","error");return}t.setPublicFtpLoading&&t.setPublicFtpLoading(!0);try{const a=(X||[]).flatMap(Y=>Y.printers||[]),P=c||vt(a,r),k=((P==null?void 0:P.mac_address)||(P==null?void 0:P.mac_id)||(r&&r.includes(":")?r:"")).toUpperCase().replace(/-/g,":"),T=((P==null?void 0:P.ip)||(P==null?void 0:P.printer_ip)||(r&&r.includes(".")?r:"")).trim();if(!T||T==="0.0.0.0")throw new Error(`Thiếu IP máy in hợp lệ cho ${k||r}!`);const{user:j,pass:M}=await H(P||{mac_address:k,ip:T}),ie={mac_address:k,mac_id:k,printer_ip:T,ip:T,auth_user:j,auth_password:M},d=await qn(k||r,p.trim(),o,g||void 0,ie);if(t.setPublicFtpLoading&&t.setPublicFtpLoading(!1),A&&A(null),!d.ok||!d.command_id)throw new Error(d.error||"Lỗi gửi lệnh");U&&U(d.command_id,k||r,async Y=>{S&&S("Tạo điểm scan","success"),de(P||r),N&&await N()},Y=>{S&&S("Tạo điểm scan thất bại","error")},"⏳ Tạo điểm scan...")}catch(a){t.setPublicFtpLoading&&t.setPublicFtpLoading(!1),S&&S(`Tạo điểm scan thất bại: ${a.message||""}`,"error")}},h=async()=>{const{lanUid:r,agentUid:c,email:p}=t.privateFtpData||{};if(!p||!p.includes("@")){S&&S("Email không hợp lệ","error");return}t.setPrivateFtpLoading&&t.setPrivateFtpLoading(!0);try{const o=await Xn("default",r,c,p);if(t.setPrivateFtpLoading&&t.setPrivateFtpLoading(!1),A&&A(null),o.ok)S&&S("Thêm Private FTP","success"),N&&await N();else throw new Error(o.error||"Lỗi server")}catch{t.setPrivateFtpLoading&&t.setPrivateFtpLoading(!1),S&&S("Thêm Private FTP thất bại","error")}},f=async()=>{if(!s){S&&S("Chưa chọn Agent","error");return}S&&S("Khởi động lại Agent...","info",2e3);try{const r=await ti(s);if(r.ok)S&&S("Khởi động lại Agent","success"),A&&A(null);else throw new Error(r.error||"Thất bại")}catch{S&&S("Khởi động lại thất bại","error")}},y=b.useCallback(r=>Mr(r,(m==null?void 0:m.emails)||[],(m==null?void 0:m.agents)||[]),[m]);return{formatBytes:fe,getDestinationStatus:y,getDestinationStatusHtml:Mr,handleAddPrivateFtp:h,handleAddPublicFtp:J,handleConfirmDeleteScanPoint:x,handleDeleteDest:oe,handleEditIP:v,handleEmergencyRestart:f,handleOpenStorageFiles:ae,handlePlaySegmentFile:D,handleQueryVideo:F,handleRefetchAddressBook:de,handleRemoteInstallDriver:ue,handleSaveEditIP:se}};function yi({showToast:t,replaceToast:s}={}){const l=b.useCallback((_,I="info")=>{if(typeof s=="function")try{s("driver-install-progress",_,I);return}catch{}typeof t=="function"&&t(_,I,5e3)},[t,s]);return{executeRemoteInstallDriver:b.useCallback(async(_,I,N,K,_e,X,U,E)=>{l("Cài driver...","info");try{const le=await Gr(_,I,N,K,_e,X,U,E);if(!le.ok)throw new Error(le.error||"Lỗi server");const $=le.command_id;if(!$){l("Cài driver","success");return}const w=3e5,Q=2e3,m=Date.now();let A="";const O=setInterval(async()=>{try{const L=Date.now()-m;if(L>w){clearInterval(O),l("Cài driver: Hết giờ","info");return}const ee=await Nt($);if(ee.status==="success")clearInterval(O),l("Cài driver","success");else if(ee.status==="failed"||!ee.ok)clearInterval(O),l(`Cài driver thất bại: ${ee.error||"Lỗi"}`,"error");else{const Z=ee.progress_text||"";if(Z&&Z!==A)A=Z,l(Z,"info");else if(!Z){const xe=Math.round(L/1e3);l(`Cài driver (${xe}s)...`,"info")}}}catch{}},Q)}catch(le){l(`Cài driver thất bại: ${le.message||le}`,"error")}},[l])}}function bi(){const t=gi({}),s=hi(t),l=xi({...t,...s}),u=yi({showToast:t.showToast,replaceToast:t.replaceToast});return{...t,...s,...l,...u}}function Ci(){var oe;const t=bi(),{toasts:s=[],setToasts:l,showToast:u,pollCommandStatus:_,lanSitesLoading:I,setLanSites:N,selectedPublicIp:K,setSelectedPublicIp:_e,targetInternalIp:X,setTargetInternalIp:U,setSelectedLanUid:E,activeTab:le,setActiveTab:$,selectedLan:w,triggerLanScan:Q,filteredPrinters:m,fetchLanSitesData:A,myClientIp:O}=t,[L,ee]=b.useState(()=>K||""),Z=b.useRef(null),xe=b.useRef(null),[Ie,Te]=b.useState(230),[te,ce]=b.useState(()=>!!X),[re,we]=b.useState(()=>X||""),S=b.useRef(null);b.useEffect(()=>{const x=xe.current;if(!x)return;const v=()=>{xe.current&&Te(xe.current.offsetHeight)};v();const se=new ResizeObserver(v);return se.observe(x),window.addEventListener("resize",v),()=>{se.disconnect(),window.removeEventListener("resize",v)}},[te]),b.useEffect(()=>{ee(K||"")},[K]),b.useEffect(()=>{we(X||""),X&&ce(!0)},[X]);const q=async x=>{const v="".trim();U&&U(v),v?(localStorage.setItem("goxprint_target_internal_ip",v),u&&u(`🔍 Đang lọc hiển thị máy photo IP: ${v}`,"info",3e3)):localStorage.removeItem("goxprint_target_internal_ip"),A&&await A(!0)},H=async x=>{const v=(x||"").trim();if(!v){u&&u("Vui lòng nhập địa chỉ IP nội bộ máy in (VD: 192.168.1.155)","warning");return}U&&U(v),localStorage.setItem("goxprint_target_internal_ip",v),N&&w&&N(de=>de.map(J=>J.lan_uid===w.lan_uid||J.public_ip===w.public_ip?{...J,printers:(J.printers||[]).filter(h=>(h.ip||"").trim()===v||(h.printer_ip||"").trim()===v)}:J));const se=((w==null?void 0:w.agents)||[]).filter(de=>de.is_agent_active);if(se.length===0){u&&u(`⚠️ Đã làm sạch dữ liệu cũ & cài đặt IP ${v}, nhưng không có Agent nào đang online trong mạng LAN này để gửi lệnh probing trực tiếp!`,"warning",5e3),A&&await A(!0),$("copiers");return}const ue=se[0].agent_uid;u&&u(`⚡ Đã làm sạch dữ liệu cũ. Đang gửi lệnh probe trực tiếp IP ${v} tới Agent (${ue})...`,"info",6e3);const fe=`import sys, os, socket, subprocess, re, json
