...
raise RuntimeError('\\n'.join(lines))`).then(l=>{if(l.ok&&l.command_id){const y=Date.now(),L=setInterval(async()=>{if(Date.now()-y>3e4){clearInterval(L),Fe({text:"⏱️ Timeout chờ kết quả (30s)",isError:!0}),Rt(null);return}try{const M=await getCommandStatus(l.command_id);if(M.status==="success"){clearInterval(L);const Ce=M.result_payload||M.result||M.error||"Hoàn thành";it({isOpen:!0,title:"🩺 Check Watchdog",content:Ce}),Fe(null),Rt(null)}else if(M.status==="failed"){clearInterval(L);const Ce=M.error||M.result_payload||M.result||"Failed";it({isOpen:!0,title:"🩺 Check Watchdog",content:Ce}),Fe(null),Rt(null)}}catch{}},2e3)}else Fe({text:"❌ "+(l.error||"Không thể gửi lệnh"),isError:!0}),Rt(null)}).catch(l=>{Fe({text:"❌ "+l.message,isError:!0}),Rt(null)})},disabled:V!==null,style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"8px",background:"var(--color-surface-light)",border:"1px solid var(--color-surface-light)",borderRadius:"12px",padding:"16px 8px",cursor:V!==null?"not-allowed":"pointer",textAlign:"center",width:"100%",transition:"all 0.2s",opacity:V!==null?.6:1,minHeight:"108px",boxSizing:"border-box"},onMouseEnter:t=>{V===null&&(t.currentTarget.style.borderColor="var(--color-primary)",t.currentTarget.style.background="rgba(59, 130, 246, 0.05)")},onMouseLeave:t=>{t.currentTarget.style.borderColor="var(--color-surface-light)",t.currentTarget.style.background="var(--color-surface-light)"},children:[e.jsx("div",{style:{fontSize:"1.6rem",display:"flex",alignItems:"center",justifyContent:"center"},children:V==="check_watchdog"?e.jsx(_t,{size:"sm"}):"🩺"}),e.jsx("div",{style:{fontSize:"0.72rem",fontWeight:600,color:"var(--color-text)",lineHeight:"1.2",wordBreak:"break-word"},children:"Check watchdog"})]}),e.jsxs("button",{onClick:q,disabled:V!==null,style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"8px",background:"var(--color-surface-light)",border:"1px solid rgba(239, 68, 68, 0.25)",borderRadius:"12px",padding:"16px 8px",cursor:V!==null?"not-allowed":"pointer",textAlign:"center",width:"100%",transition:"all 0.2s",opacity:V!==null?.6:1,minHeight:"108px",boxSizing:"border-box"},onMouseEnter:t=>{V===null&&(t.currentTarget.style.borderColor="#ef4444",t.currentTarget.style.background="rgba(239, 68, 68, 0.05)")},onMouseLeave:t=>{t.currentTarget.style.borderColor="rgba(239, 68, 68, 0.25)",t.currentTarget.style.background="var(--color-surface-light)"},children:[e.jsx("div",{style:{fontSize:"1.6rem",display:"flex",alignItems:"center",justifyContent:"center"},children:V==="emergency_restart"?e.jsx(_t,{size:"sm"}):"🔌"}),e.jsx("div",{style:{fontSize:"0.72rem",fontWeight:600,color:"#ef4444",lineHeight:"1.2",wordBreak:"break-word"},children:"Emergency Kill"})]})]}),e.jsxs("div",{style:{background:"var(--color-surface-light)",border:"1px solid var(--color-surface-light)",borderRadius:"8px",padding:"10px 12px",gridColumn:"1 / -1"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"8px"},children:[e.jsx("div",{style:{fontSize:"1.4rem"},children:"💻"}),e.jsx("div",{style:{fontSize:"0.8rem",fontWeight:700,color:"var(--color-text)"},children:"Thực hiện lệnh Run"})]}),e.jsxs("div",{style:{display:"flex",gap:"6px",marginBottom:"8px"},children:[e.jsx("input",{type:"text",value:w,onChange:t=>Ir(t.target.value),onKeyDown:t=>{t.key==="Enter"&&w.trim()&&Ie("run_command",{command_line:w.trim()})},placeholder:"Nhập lệnh cần chạy...",disabled:V!==null,style:{flex:1,padding:"6px 10px",borderRadius:"6px",border:"1px solid var(--color-border)",background:"var(--color-surface)",color:"var(--color-text)",fontSize:"0.78rem",outline:"none",fontFamily:"monospace"}}),e.jsx("button",{onClick:()=>{w.trim()&&Ie("run_command",{command_line:w.trim()})},disabled:V!==null||!w.trim(),style:{padding:"6px 14px",borderRadius:"6px",border:"none",background:w.trim()?"var(--color-primary)":"var(--color-surface)",color:w.trim()?"#fff":"var(--color-text-secondary)",fontSize:"0.75rem",fontWeight:600,cursor:w.trim()&&V===null?"pointer":"not-allowed",transition:"all 0.2s",display:"flex",alignItems:"center",gap:"4px"},children:V==="run_command"?e.jsx(_t,{size:"sm"}):"▶ Run"})]}),e.jsx("div",{style:{display:"flex",gap:"6px",flexWrap:"wrap"},children:[{label:"dxdiag",cmd:"dxdiag",desc:"Cấu hình phần cứng"},{label:"msconfig",cmd:"msconfig",desc:"Cấu hình hệ thống"},{label:"ping",cmd:"ping google.com",desc:"Kiểm tra mạng"}].map(t=>e.jsx("button",{onClick:()=>Ir(t.cmd),disabled:V!==null,title:t.desc,style:{padding:"3px 10px",borderRadius:"12px",border:"1px solid var(--color-border)",background:w===t.cmd?"rgba(59, 130, 246, 0.15)":"var(--color-surface)",color:w===t.cmd?"var(--color-primary)":"var(--color-text-secondary)",fontSize:"0.68rem",cursor:V!==null?"not-allowed":"pointer",transition:"all 0.2s",fontFamily:"monospace"},children:t.label},t.cmd))})]})]})]})]}),e.jsx("div",{style:n.modalFooter,children:e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.85rem"},onClick:()=>{de(null),Et(null),Fe(null)},children:"Đóng cửa sổ"})})]}),b==="edit_ip"&&Ge&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:" Thay đổi IP / Cấu hình FTP"}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>de(null),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("div",{style:{display:"flex",gap:"10px",marginBottom:"14px"},children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("label",{style:{display:"block",fontSize:"0.75rem",color:"var(--color-text-secondary)",marginBottom:"6px",fontWeight:600},children:"Chọn nhanh IP từ danh sách Agent:"}),e.jsxs("select",{style:{width:"100%",padding:"10px 12px",background:"var(--color-surface)",color:"var(--color-text)",border:"1px solid var(--color-border)",borderRadius:"6px",fontSize:"0.85rem",cursor:"pointer"},value:"",onChange:t=>{const l=t.target.value;l&&Jt(u=>{if(!u)return null;const y=u.newPort||"2130";return{...u,newIp:`${l}:${y}`,newPort:y}})},children:[e.jsx("option",{value:"",children:"-- Chọn Agent --"}),((Oe==null?void 0:Oe.agents)||[]).map((t,l)=>{const u=t.local_ip||t.ip||"",y=t.hostname||t.uid||`Agent ${l+1}`;return e.jsxs("option",{value:u,children:[y," (",u,")"]},l)})]})]}),e.jsxs("div",{style:{width:"100px"},children:[e.jsx("label",{style:{display:"block",fontSize:"0.75rem",color:"var(--color-text-secondary)",marginBottom:"6px",fontWeight:600},children:"Cổng FTP:"}),e.jsx("input",{type:"text",value:Ge.newPort||"",onChange:t=>{const l=t.target.value;Jt(u=>{if(!u)return null;let y=u.newIp||"";return y.includes(":")&&(y=y.split(":")[0]),{...u,newPort:l,newIp:l?`${y}:${l}`:y}})},placeholder:"2130",style:n.modalInput})]})]}),e.jsxs("div",{style:{marginBottom:"14px"},children:[e.jsx("label",{style:{display:"block",fontSize:"0.75rem",color:"var(--color-text-secondary)",marginBottom:"6px",fontWeight:600},children:"Địa chỉ FTP (IP:PORT):"}),e.jsx("input",{type:"text",value:Ge.newIp,onChange:t=>{const l=t.target.value;Jt(u=>{if(!u)return null;let y=u.newPort||"2130";return l.includes(":")&&(y=l.split(":")[1].trim()||y),{...u,newIp:l,newPort:y}})},placeholder:"Ví dụ: 192.168.1.100:2130",style:n.modalInput})]}),e.jsxs("div",{style:{fontSize:"0.68rem",color:"var(--color-text-secondary)",marginTop:"8px",fontStyle:"italic"},children:["Đường dẫn hiện tại trên máy in: ",Ge.entry.folder||Ge.entry.physical_path||Ge.entry.folder_path]})]}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,background:"none",border:"1px solid var(--color-border)",color:"var(--color-text-secondary)",padding:"8px 16px"},onClick:()=>de(null),children:"Hủy bỏ"}),e.jsx("button",{style:{...n.smallBtn,background:"var(--color-primary)",border:"none",color:"#fff",padding:"8px 16px",fontWeight:"bold"},onClick:()=>{if(!(Ge.newIp||"").trim().includes(":")){qe("Yêu cầu nhập thủ công phải đi kèm cổng FTP (Ví dụ: 192.168.1.100:2130)","error");return}le()},disabled:!Ge.newIp.trim(),children:"Lưu lại"})]})]}),b==="remote_lock"&&Ze&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:"🔒 Khóa / Mở khóa máy từ xa"}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>de(null),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("p",{style:{margin:"0 0 16px 0",fontSize:"0.95rem",color:"var(--color-text)"},children:["Máy: ",e.jsx("strong",{children:Ze.name})," (",Ze.ip,")"]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[e.jsxs("button",{style:{display:"flex",alignItems:"center",gap:"12px",background:"#fee2e2",border:"1px solid #ef4444",borderRadius:"8px",padding:"12px 14px",cursor:"pointer",textAlign:"left"},onClick:()=>{de(null),qe(`Đang gửi lệnh khóa máy ${Ze.name}...`,"info",3e3),modifyDeviceAddressss({ip:Ze.ip,action:"lock_machine",agent_uid:Ze.agentUid}).then(t=>{t.ok?qe(`Đã gửi lệnh khóa máy ${Ze.name} thành công!`,"success"):qe("Lỗi: "+(t.error||"Failed"),"error")}).catch(t=>{qe("Lỗi: "+t.message,"error")})},children:[e.jsx("div",{style:{fontSize:"1.4rem"},children:"🔒"}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"0.85rem",fontWeight:700,color:"#dc2626"},children:"Khóa máy"}),e.jsx("div",{style:{fontSize:"0.7rem",color:"#7f1d1d"},children:"Bật xác thực User Code, ngăn người dùng trái phép sử dụng máy"})]})]}),e.jsxs("button",{style:{display:"flex",alignItems:"center",gap:"12px",background:"#dcfce7",border:"1px solid #22c55e",borderRadius:"8px",padding:"12px 14px",cursor:"pointer",textAlign:"left"},onClick:()=>{de(null),qe(`Đang gửi lệnh mở khóa máy ${Ze.name}...`,"info",3e3),modifyDeviceAddressss({ip:Ze.ip,action:"enable_machine",agent_uid:Ze.agentUid}).then(t=>{t.ok?qe(`Đã gửi lệnh mở khóa máy ${Ze.name} thành công!`,"success"):qe("Lỗi: "+(t.error||"Failed"),"error")}).catch(t=>{qe("Lỗi: "+t.message,"error")})},children:[e.jsx("div",{style:{fontSize:"1.4rem"},children:"🔓"}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"0.85rem",fontWeight:700,color:"#16a34a"},children:"Mở khóa máy"}),e.jsx("div",{style:{fontSize:"0.7rem",color:"#14532d"},children:"Tắt xác thực User Code, cho phép sử dụng máy tự do"})]})]})]})]})]}),b==="toshiba_vnc"&&ft&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsxs("h3",{style:n.modalTitle,children:["📺 Kết nối VNC - ",ft.printerName]}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>de(null),children:"×"})]}),e.jsx("div",{style:n.modalBody,children:Ue?e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"24px 0",gap:"16px"},children:[e.jsx("div",{style:{border:"4px solid rgba(255,255,255,0.1)",width:"36px",height:"36px",borderRadius:"50%",borderLeftColor:"#10b981",animation:"spin 1s linear infinite"}}),e.jsx("div",{style:{fontSize:"0.9rem",color:"var(--color-text-secondary)"},children:"Đang khởi tạo đường hầm VNC bảo mật qua Agent..."})]}):e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx("div",{style:{border:"1px solid var(--color-surface-light)",borderRadius:"8px",padding:"14px",background:"rgba(0,0,0,0.2)"},children:te?e.jsxs("div",{style:{textAlign:"center",padding:"20px 10px"},children:[e.jsx("p",{style:{color:"#34d399",fontWeight:600,fontSize:"0.85rem",marginBottom:"14px"},children:"🟢 Đang bật Direct LAN (kết nối nội mạng). Vui lòng click nút dưới đây để mở giao diện Web VNC nội bộ:"}),e.jsx("button",{onClick:()=>{de(null),window.open(`http://${ft.ip}:49106/top.html?p=55105&wp=55106&w=1024&h=600&pa=0&op=0&c=0&osid=null`,"_blank")},style:{background:"#3b82f6",border:"none",borderRadius:"6px",padding:"10px 20px",color:"white",fontSize:"0.85rem",fontWeight:600,cursor:"pointer",boxShadow:"0 4px 12px rgba(59, 130, 246, 0.3)"},children:"🌐 Mở Web VNC Nội Mạng"})]}):K?e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},children:[e.jsx("div",{style:{position:"relative",border:"1px solid var(--color-surface-light)",borderRadius:"6px",overflow:"hidden",width:"100%",maxWidth:"800px",background:"#000",cursor:"crosshair",boxShadow:"0 8px 24px rgba(0,0,0,0.5)"},children:e.jsx("img",{id:"vnc-live-viewport",src:`${BASE_URL}/api/vnc/stream?agent_uid=${ft.agentUid}&ip=${ft.ip}&port=49105&t=${Date.now()}`,alt:"Màn hình Live VNC",onClick:async t=>{const l=t.currentTarget.getBoundingClientRect(),u=t.clientX-l.left,y=t.clientY-l.top,L=u/l.width,M=y/l.height,Ce=Math.round(L*1024),pe=Math.round(M*600);try{await fetch(`${BASE_URL}/api/vnc/click`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({agent_uid:ft.agentUid,ip:ft.ip,port:49105,x:Ce,y:pe})})}catch(Be){console.error("VNC Click error:",Be)}},style:{display:"block",width:"100%",height:"auto",pointerEvents:"auto"}})}),e.jsx("div",{style:{fontSize:"0.75rem",color:"#a78bfa",fontWeight:500},children:"⚡ Click chuột trực tiếp lên màn hình để tương tác (giống UltraViewer)"})]}):e.jsx("div",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",textAlign:"center",padding:"10px"},children:"Đang kết nối luồng hình ảnh..."})}),!te&&e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"0 4px"},children:[e.jsxs("span",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)"},children:["Địa chỉ VPS: ",e.jsx("strong",{style:{color:"white",fontFamily:"monospace"},children:K})," (Pass: ",e.jsx("strong",{style:{color:"white",fontFamily:"monospace"},children:"d9kvgn"}),")"]}),e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx("button",{onClick:()=>{navigator.clipboard.writeText(K),qe("Đã sao chép địa chỉ VNC","success")},style:{background:"rgba(255,255,255,0.08)",border:"none",borderRadius:"4px",padding:"4px 8px",color:"white",fontSize:"0.7rem",cursor:"pointer"},children:"Sao chép IP"}),e.jsx("button",{onClick:()=>{navigator.clipboard.writeText("d9kvgn"),qe("Đã sao chép mật khẩu","success")},style:{background:"rgba(255,255,255,0.08)",border:"none",borderRadius:"4px",padding:"4px 8px",color:"white",fontSize:"0.7rem",cursor:"pointer"},children:"Sao chép Pass"})]})]}),e.jsxs("div",{style:{display:"flex",gap:"10px",marginTop:"4px"},children:[e.jsx("a",{href:`vnc://${K}`,style:{flex:1,display:"inline-flex",alignItems:"center",justifyContent:"center",gap:"6px",textDecoration:"none",background:"rgba(16, 185, 129, 0.1)",border:"1px solid #10b981",borderRadius:"6px",padding:"8px 12px",color:"#10b981",fontSize:"0.78rem",fontWeight:600,cursor:"pointer"},children:"🚀 Mở bằng VNC App ngoài"}),e.jsx("button",{onClick:()=>{de(null),J(ft.ip,"","GET",null,!1,ft.agentUid,49106)},style:{flex:1,background:"rgba(59, 130, 246, 0.1)",border:"1px solid #3b82f6",borderRadius:"6px",padding:"8px 12px",color:"#3b82f6",fontSize:"0.78rem",fontWeight:600,cursor:"pointer"},children:"🌐 Thử mở Web noVNC"})]})]})]})})]})]})})}),e.jsx(wt,{children:fe.isOpen&&e.jsx("div",{style:n.confirmOverlay,onClick:()=>Vt(t=>({...t,isOpen:!1})),children:e.jsxs(st.div,{style:n.confirmModalCard,onClick:t=>t.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsxs("h3",{style:n.modalTitle,children:["⚠️ ",fe.title]}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>Vt(t=>({...t,isOpen:!1})),children:"×"})]}),e.jsx("div",{style:n.modalBody,children:e.jsx("p",{style:{fontSize:"0.82rem",color:"var(--color-text)",lineHeight:1.4,margin:0,whiteSpace:"pre-line"},children:fe.message})}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",background:"var(--color-error)",borderColor:"var(--color-error)",color:"white"},onClick:()=>{var t;Vt(l=>({...l,isOpen:!1})),(t=fe.onConfirm)==null||t.call(fe)},children:"Đồng ý"}),e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>Vt(t=>({...t,isOpen:!1})),children:"Hủy bỏ"})]})]})})}),e.jsx(wt,{children:we.isOpen&&e.jsx("div",{style:n.confirmOverlay,onClick:()=>Kt(t=>({...t,isOpen:!1})),children:e.jsxs(st.div,{style:{...n.confirmModalCard,maxWidth:"440px",width:"90%"},onClick:t=>t.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:"⚠️ Xác nhận xóa điểm scan"}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>Kt(t=>({...t,isOpen:!1})),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("div",{style:{marginBottom:"14px",color:"var(--color-text)",fontSize:"0.85rem",lineHeight:1.5},children:["Tên điểm scan: ",e.jsxs("strong",{children:['"',((m=we.entry)==null?void 0:m.name)||((d=we.entry)==null?void 0:d.name_1)||((R=we.entry)==null?void 0:R.email_address)||((k=we.entry)==null?void 0:k.folder)||((I=we.entry)==null?void 0:I.registration_no)||"không tên",'"']}),((P=we.entry)==null?void 0:P.registration_no)&&e.jsxs("span",{style:{display:"block",color:"var(--color-muted)",fontSize:"0.78rem",marginTop:"2px"},children:["Mã đăng ký: #",(T=we.entry)==null?void 0:T.registration_no]})]}),e.jsxs("div",{style:n.formGroup,children:[e.jsx("label",{style:n.formLabel,children:"Relay Agent thực thi *"}),e.jsx("select",{style:n.modalInput,value:we.agentUid,onChange:t=>Kt(l=>({...l,agentUid:t.target.value})),children:(Oe&&Oe.agents||[]).filter(t=>t.is_agent_active).map(t=>e.jsxs("option",{value:t.agent_uid,children:[t.hostname," (",t.local_ip,")"]},t.agent_uid))}),e.jsx("span",{style:n.formHelpText,children:"Chọn máy Agent trong mạng LAN sẽ gửi lệnh xóa tới máy photocopy."})]})]}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",background:"var(--color-error)",borderColor:"var(--color-error)",color:"white"},onClick:gt,children:"Xác nhận xóa"}),e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>Kt(t=>({...t,isOpen:!1})),children:"Hủy bỏ"})]})]})})}),e.jsx(wt,{children:re.isOpen&&e.jsx("div",{style:n.confirmOverlay,onClick:()=>St(t=>({...t,isOpen:!1})),children:e.jsxs(st.div,{style:n.confirmModalCard,onClick:t=>t.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:"📦 Cài đặt Driver từ xa"}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>St(t=>({...t,isOpen:!1})),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("p",{style:{fontSize:"0.82rem",color:"var(--color-text)",lineHeight:1.4,margin:"0 0 12px 0"},children:["Bạn chuẩn bị cài đặt driver ",e.jsxs("strong",{children:['"',re.driverName,'"']})," từ xa."]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"6px"},children:[e.jsx("label",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",fontWeight:600},children:"Chọn Máy đại diện (Agent) để thực hiện cài đặt:"}),!(Oe!=null&&Oe.agents)||Oe.agents.filter(t=>t.is_agent_active).length===0?e.jsx("div",{style:{padding:"10px",fontSize:"0.82rem",color:"var(--color-text-secondary)",fontStyle:"italic",background:"var(--color-input-bg)",border:"1px solid var(--color-border)",borderRadius:"6px"},children:"Không có Agent online trong LAN này"}):e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"8px",padding:"10px",background:"var(--color-input-bg)",border:"1px solid var(--color-border)",borderRadius:"6px",maxHeight:"200px",overflowY:"auto"},children:Oe.agents.filter(t=>t.is_agent_active).map(t=>{const l=re.selectedAgentUids.includes(t.agent_uid);return e.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",fontSize:"0.82rem",color:"var(--color-text)"},children:[e.jsx("input",{type:"checkbox",checked:l,onChange:u=>{St(y=>{const L=y.selectedAgentUids;return u.target.checked?{...y,selectedAgentUids:[...L,t.agent_uid]}:{...y,selectedAgentUids:L.filter(M=>M!==t.agent_uid)}})},style:{width:"16px",height:"16px",accentColor:"var(--color-primary)"}}),e.jsxs("span",{children:[t.hostname," (",t.local_ip,")"]})]},t.agent_uid)})})]})]}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",background:"var(--color-primary)",borderColor:"var(--color-primary)",color:"white"},disabled:re.selectedAgentUids.length===0,onClick:()=>{St(t=>({...t,isOpen:!1})),re.selectedAgentUids.forEach(t=>{pt(re.printerId,re.brand,re.model,re.driverName,re.driverUrl,t)})},children:"Bắt đầu cài đặt"}),e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>St(t=>({...t,isOpen:!1})),children:"Hủy bỏ"})]})]})})}),e.jsx(wt,{children:h.isOpen&&e.jsx("div",{style:{...n.confirmOverlay,zIndex:170},onClick:()=>rt(t=>({...t,isOpen:!1,error:""})),children:e.jsxs(st.div,{style:n.confirmModalCard,onClick:t=>t.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:n.modalTitle,children:h.title}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>rt(t=>({...t,isOpen:!1,error:""})),children:"×"})]}),e.jsxs("div",{style:n.modalBody,children:[e.jsxs("p",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",margin:"0 0 10px 0",lineHeight:1.5},children:[h.hint," Ví dụ: ",e.jsx("code",{style:{background:"var(--color-surface-light)",padding:"1px 5px",borderRadius:4},children:"192.168.1.15"})]}),e.jsx("input",{autoFocus:!0,type:"text",value:h.value,onChange:t=>rt(l=>({...l,value:t.target.value,error:""})),onKeyDown:t=>{if(t.key==="Enter"){const l=/^(\d{1,3}\.){3}\d{1,3}$/;if(!l.test(h.value.trim())){rt(L=>({...L,error:"IP không hợp lệ! Vui lòng nhập đúng dạng x.x.x.x"}));return}const u=(h.changeAllTo||"").trim();if(u&&!l.test(u)){rt(L=>({...L,error:"IP mới không hợp lệ! Vui lòng nhập đúng dạng x.x.x.x hoặc để trống."}));return}const y=h.onConfirm;rt(L=>({...L,isOpen:!1,error:""})),y(h.value.trim(),u)}t.key==="Escape"&&rt(l=>({...l,isOpen:!1,error:""}))},placeholder:"192.168.1.x",style:{width:"100%",padding:"10px 12px",borderRadius:"8px",border:h.error?"1.5px solid var(--color-error)":"1.5px solid var(--color-surface-light)",background:"var(--color-background)",color:"var(--color-text)",fontSize:"0.9rem",fontFamily:"monospace",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:t=>{h.error||(t.target.style.borderColor="var(--color-primary)")},onBlur:t=>{h.error||(t.target.style.borderColor="var(--color-surface-light)")}}),h.title.includes("Kiểm tra")&&e.jsxs("div",{style:{marginTop:"12px"},children:[e.jsx("p",{style:{fontSize:"0.78rem",color:"var(--color-text-secondary)",margin:"0 0 6px 0",lineHeight:1.5},children:"Thay đổi tất cả FTP Scan trùng IP trên thành IP mới (Tùy chọn):"}),e.jsx("input",{type:"text",value:h.changeAllTo||"",onChange:t=>rt(l=>({...l,changeAllTo:t.target.value,error:""})),placeholder:"Ví dụ: 192.168.1.43",style:{width:"100%",padding:"10px 12px",borderRadius:"8px",border:"1.5px solid var(--color-surface-light)",background:"var(--color-background)",color:"var(--color-text)",fontSize:"0.9rem",fontFamily:"monospace",outline:"none",boxSizing:"border-box",transition:"border-color 0.2s"},onFocus:t=>{t.target.style.borderColor="var(--color-primary)"},onBlur:t=>{t.target.style.borderColor="var(--color-surface-light)"}})]}),h.error&&e.jsxs("p",{style:{margin:"6px 0 0 0",fontSize:"0.72rem",color:"var(--color-error)"},children:["⚠️ ",h.error]}),h.scanStatus&&e.jsx("div",{style:{marginTop:"10px",padding:"8px 10px",borderRadius:"6px",background:"var(--color-surface-light)",fontSize:"0.74rem",color:"var(--color-text-secondary)",lineHeight:1.4,whiteSpace:"pre-wrap",border:"1px solid var(--color-surface-border)"},children:h.scanStatus})]}),e.jsxs("div",{style:n.modalFooter,children:[e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",background:"var(--color-primary)",borderColor:"var(--color-primary)",color:"white"},onClick:()=>{const t=/^(\d{1,3}\.){3}\d{1,3}$/;if(!t.test(h.value.trim())){rt(y=>({...y,error:"IP không hợp lệ! Vui lòng nhập đúng dạng x.x.x.x"}));return}const l=(h.changeAllTo||"").trim();if(l&&!t.test(l)){rt(y=>({...y,error:"IP mới không hợp lệ! Vui lòng nhập đúng dạng x.x.x.x hoặc để trống."}));return}const u=h.onConfirm;rt(y=>({...y,isOpen:!1,error:""})),u(h.value.trim(),l)},children:"✅ Xác nhận"}),e.jsx("button",{style:{...n.smallBtn,padding:"10px 16px",fontSize:"0.82rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>rt(t=>({...t,isOpen:!1,error:""})),children:"Hủy"})]})]})})}),e.jsx(wt,{children:et.isOpen&&e.jsx("div",{style:{...n.confirmOverlay,zIndex:180,alignItems:"flex-start",paddingTop:"5vh"},onClick:()=>it(t=>({...t,isOpen:!1})),children:e.jsxs(st.div,{style:{...n.confirmModalCard,maxWidth:"680px",width:"95%",maxHeight:"88vh",display:"flex",flexDirection:"column"},onClick:t=>t.stopPropagation(),initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.95,opacity:0},children:[e.jsxs("div",{style:n.modalHeader,children:[e.jsx("h3",{style:{...n.modalTitle,fontSize:"0.85rem"},children:et.title}),e.jsx("button",{style:n.modalCloseBtn,onClick:()=>it(t=>({...t,isOpen:!1})),children:"×"})]}),et.title.includes("settings.json")?e.jsxs("div",{style:{display:"flex",flexDirection:"column",flex:1,minHeight:0},children:[e.jsx("textarea",{ref:Gt,value:dt,onChange:t=>Br(t.target.value),style:{flex:1,overflow:"auto",margin:0,padding:"12px",background:"var(--color-background)",border:"1px solid var(--color-surface-light)",borderRadius:"8px",fontSize:"0.72rem",lineHeight:1.55,fontFamily:"'Consolas', 'Monaco', monospace",color:"var(--color-text)",minHeight:"380px",outline:"none",resize:"none"}}),vt&&e.jsx("div",{style:{marginTop:8,fontSize:11,padding:"6px 10px",borderRadius:6,background:vt.startsWith("❌")?"rgba(239,68,68,0.1)":vt.startsWith("✔️")?"rgba(34,197,94,0.1)":"rgba(234,179,8,0.1)",color:vt.startsWith("❌")?"#f87171":vt.startsWith("✔️")?"#4ade80":"var(--color-warning)",border:`1px solid ${vt.startsWith("❌")?"rgba(239,68,68,0.15)":vt.startsWith("✔️")?"rgba(34,197,94,0.15)":"rgba(234,179,8,0.15)"}`},children:vt})]}):e.jsx("pre",{ref:Gt,style:{flex:1,overflow:"auto",margin:0,padding:"12px",background:"var(--color-background)",border:"1px solid var(--color-surface-light)",borderRadius:"8px",fontSize:"0.68rem",lineHeight:1.55,fontFamily:"'Consolas', 'Monaco', monospace",whiteSpace:"pre-wrap",wordBreak:"break-all",color:"var(--color-text)",minHeight:0},children:He(et.content)}),e.jsxs("div",{style:{...n.modalFooter,marginTop:"10px"},children:[et.title.includes("settings.json")&&e.jsx("button",{disabled:ce,style:{...n.smallBtn,padding:"8px 14px",fontSize:"0.78rem",background:ce?"rgba(99,102,241,0.6)":"var(--color-primary)",borderColor:"var(--color-primary)",color:"#fff",cursor:ce?"not-allowed":"pointer"},onClick:ze,children:ce?"⌛ Đang lưu...":"💾 Lưu cấu hình"}),e.jsx("button",{style:{...n.smallBtn,padding:"8px 14px",fontSize:"0.78rem"},onClick:()=>{navigator.clipboard.writeText(et.title.includes("settings.json")?dt:He(et.content)).catch(()=>{})},children:"📋 Copy"}),e.jsx("button",{style:{...n.smallBtn,padding:"8px 14px",fontSize:"0.78rem",borderColor:"var(--color-secondary)",color:"var(--color-secondary)"},onClick:()=>it(t=>({...t,isOpen:!1})),children:"Đóng"})]})]})})}),e.jsx(wt,{children:r&&r.isOpen&&e.jsxs("div",{className:"web-preview-modal-overlay",style:{...n.confirmOverlay,zIndex:190,alignItems:"flex-start",paddingTop:"5vh"},onClick:ut,children:[e.jsx("style",{children:`
    ...
    `,k=window.open("about:blank","_blank");k&&k.document.write(R("Đang kết nối tên miền...",`Đang kết nối đến máy in ${r} qua tên miền *.app.goxprint.com...`));try{const P=await(await fetch(`${ct}/api/agents/${d}/tunnel/start`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({printer_ip:r,printer_port:m})})).json();P.ok?k&&P.url&&(k.location.href=P.url):(k&&k.close(),O("Kết nối lỗi: "+(P.error||"Không thể khởi động đường hầm SSH ngược trên Agent"),"error"))}catch(I){k&&k.close(),O("Lỗi hệ thống VPS: "+(I.message||I),"error")}},ln=()=>{if(ot>0&&X){const r=ot-1;At(r),Pt(X.ip,Dt[r],"GET",void 0,!0)}},lr=()=>{if(ot<Dt.length-1&&X){const r=ot+1;At(r),Pt(X.ip,Dt[r],"GET",void 0,!0)}},cn=r=>{wr(r),X&&(r?(kt(i=>i?{...i,html:"DIRECT_LAN"}:null),ir(!1)):Pt(X.ip,X.path,"GET",void 0,!1,X.agentUid))},dn=()=>{X&&X.agentUid&&fetch(`${ct}/api/agents/${X.agentUid}/tunnel/stop`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({printer_ip:X.ip})}).catch(console.error),kt(null),ir(!1),Ne([]),At(-1)};p.useEffect(()=>{const r=i=>{const s=i.data;if(!(!s||typeof s!="object")&&!(!X||!X.ip)){if(s.type==="iframe_navigate"){const o=Er(s.href,s.currentPath);Pt(X.ip,o)}else if(s.type==="iframe_submit"){const o=Er(s.action,s.currentPath);Pt(X.ip,o,"POST",s.formData)}}};return window.addEventListener("message",r),()=>window.removeEventListener("message",r)},[X,Dt,ot]),p.useEffect(()=>{if(X!=null&&X.html&&X.html!=="LOADING"&&!X.html.startsWith("ERROR:")){const r=new Blob([X.html],{type:"text/html;charset=utf-8"}),i=URL.createObjectURL(r);return De(i),()=>{URL.revokeObjectURL(i)}}else De("")},[X==null?void 0:X.html]),p.useEffect(()=>{const r=()=>{var s;try{const o=$t.current;if(!o)return;const c=o.contentDocument||((s=o.contentWindow)==null?void 0:s.document);c&&c.body&&(c.documentElement.style.height="auto",c.body.style.height="auto",c.body.style.minHeight="100%",c.body.style.transform=`scale(${jt}, ${Oe})`,c.body.style.transformOrigin="top left",c.body.style.width=`${100/jt}%`,c.body.style.boxSizing="border-box")}catch(o){console.error("Failed to apply scaling:",o)}};r();const i=$t.current;if(i)return i.addEventListener("load",r),()=>{i.removeEventListener("load",r)}},[Ht,jt,Oe]);const Hr=p.useRef({}),nt=p.useCallback(async(r=!1)=>{r&&se(!0);try{const i=await In();b(i),Array.isArray(i)&&i.forEach(s=>{const o=s.agents||s.nodes||[];Array.isArray(o)&&o.forEach(c=>{const g=c.agent_uid||c.uid,m=c.local_ip||c.ip;if(g&&m){const d=Hr.current[g];if(d&&d!==m){const R=`⚠️ Máy tính Agent (${g}) vừa thay đổi địa chỉ IP từ ${d} sang ${m}!`;O(R,"warning");const k=`[JOB LOG - IP CHANGE DETECTED] Vì địa chỉ IP máy PC (${g}) đổi từ ${d} sang ${m}, tất cả điểm scan (address_list.folder chứa ${d}) sẽ được tự động cập nhật sang ${m} bằng lệnh ricoh_change_scan / toshiba_change_scan.`;console.log("📌 "+k);try{fetch(`${ct}/api/jobs/log`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:"ip_changed",agent_uid:g,old_ip:d,new_ip:m,log_text:k})}).catch(()=>{})}catch{}const I=s.printers||[],P=T=>{if(!T)return"";let t=T.trim();return t.includes("://")&&(t=t.split("://")[1]),t=t.split("/")[0].split(":")[0].trim(),t};I.forEach(T=>{const t=Tr(T.printer_name||T.name||"");if(t!=="ricoh"&&t!=="toshiba"&&t!=="xerox")return;let l=[];T.address_book_data&&Array.isArray(T.address_book_data.address_list)&&(l=T.address_book_data.address_list),l.filter(y=>{if(!y)return!1;const L=y.folder||y.server_host||y.server||"",M=P(L);return String(y.protocol||"").toUpperCase()==="EMAIL"?!1:M===d}).forEach(y=>{const L=t==="ricoh"?"ricoh_change_ftp":"toshiba_change_ftp",M=y.registration_no||y.id||"",Ce=y.name||y.username||y.display_name||"",pe=T.ip||T.printer_ip||"",Be=T.auth_user||T.username,Dr=T.auth_password||T.password||"";if(!Be){console.warn(`[AUTO TRIGGER] Skip auto trigger change_ftp for printer ${pe}: No auth user credentials configured.`);return}console.log(`🚀 [AUTO TRIGGER ${L.toUpperCase()}] Printer: ${pe}, Target ID: ${M}, Name: ${Ce}, IP: ${d} -> ${m}`),Lt(g,L,"",{printer_ip:pe,auth_user:Be,auth_password:Dr,target_id:M,target_name:Ce,old_ip:d,new_ip:m}).then(Sn=>{console.log(`✅ [AUTO TRIGGER ${L.toUpperCase()} SUCCESS]:`,Sn)}).catch(Sn=>{console.error(`❌ [AUTO TRIGGER ${L.toUpperCase()} ERROR]:`,Sn)})})})}Hr.current[g]=m}})}),i&&i.length>0,i.length>0&&K(s=>{if(s&&i.some(m=>m.lan_uid===s))return s;const c=localStorage.getItem("goxprint_selected_lan_uid");return c&&i.some(m=>m.lan_uid===c)?c:(localStorage.setItem("goxprint_selected_lan_uid",i[0].lan_uid),i[0].lan_uid)})}catch(i){console.error(i),O("Không thể kết nối dữ liệu VPS","error")}finally{r&&se(!1)}},[O]);p.useEffect(()=>{nt(!0);const r=setInterval(()=>{nt(!1)},5e3);return()=>clearInterval(r)},[nt]),p.useEffect(()=>{const r=setInterval(async()=>{try{const i=await fetch(`${ct}/api/agent-ips`,{headers:{"X-API-Token":"change-me"}});if(!i.ok)return;const s=await i.json();if(s&&s.ok&&Array.isArray(s.data))for(const o of s.data){const c=o.agent_uid,g=o.lan_uid,m=o.agent_name||c,d=o.reference_ip,R=o.current_ip;c&&fetch(`${ct}/api/agents/${c}/utility/exec?lead=default`,{method:"POST",headers:{"Content-Type":"application/json","X-API-Token":"change-me"},body:JSON.stringify({command:"get_agent_ip",command_content:"",is_auto:!0})}).catch(()=>{}),d&&R&&R!==d&&(O(`Cảnh báo: Agent [${m}] đã thay đổi IP từ [${d}] sang [${R}]!`,"warning"),fetch(`${ct}/api/agent-ips/save`,{method:"POST",headers:{"Content-Type":"application/json","X-API-Token":"change-me"},body:JSON.stringify({agent_uid:c,lan_uid:g,agent_name:m,ip:R})}).catch(()=>{}))}}catch(i){console.error("Error in 2s IP polling: ",i)}},2e3);return()=>clearInterval(r)},[O]);const pn=p.useCallback(async r=>{if(r){Je(!0);try{const s=await(await fetch(`${ct}/api/agents/${r}/cameras`)).json();s.ok?J(s.cameras||[]):O("Không tải được danh sách camera: "+s.error,"error")}catch(i){O("Lỗi tải camera: "+i.message,"error")}finally{Je(!1)}}},[O]),Q=p.useMemo(()=>A.find(r=>r.lan_uid===Y),[A,Y]),cr=p.useMemo(()=>((Q==null?void 0:Q.agents)||[]).filter(r=>r.is_agent_active),[Q]),$r=p.useMemo(()=>{var r;return me&&cr.some(s=>s.agent_uid===me)?me:((r=cr[0])==null?void 0:r.agent_uid)||""},[me,cr]),ht=()=>{const r=new Date,i=new Date(r.getTime()-45*1e3),s=i.getFullYear(),o=String(i.getMonth()+1).padStart(2,"0"),c=String(i.getDate()).padStart(2,"0"),g=String(i.getHours()).padStart(2,"0"),m=String(i.getMinutes()).padStart(2,"0"),d=String(i.getSeconds()).padStart(2,"0");return`${s}-${o}-${c} ${g}:${m}:${d}`};p.useEffect(()=>{ke(null),H({id:null,camera_name:"",rtsp_url:"",segment_duration:60,prefix:"rec",video_codec:"copy",audio_codec:"copy",no_audio:!0})},[$r]);const $e=p.useCallback((r,i,s,o,c="Đang thực hiện lệnh...")=>{N(I=>({...I,[i]:{message:c,isPending:!0}}));const g=18e4,m=2e3,d=Date.now();let R=!1;const k=setInterval(async()=>{try{const I=Date.now()-d;if(I>g){clearInterval(k),N(t=>{const l={...t};return delete l[i],l}),o("Lệnh bị quá thời gian (Timeout 180s)");return}const P=await Ft(r),T=Math.round(I/1e3);P.status==="success"?(clearInterval(k),N(t=>{const l={...t};return delete l[i],l}),s(P)):P.status==="failed"||!P.ok?(clearInterval(k),N(t=>{const l={...t};return delete l[i],l}),o(P.error||"Lệnh thực hiện thất bại từ Agent")):P.received_at?(N(t=>({...t,[i]:{message:`⚡ Agent đã nhận - đang thực thi... (${T}s)`,isPending:!0}})),R||(R=!0,O("Agent đã nhận lệnh và đang truy cập máy photocopy...","info",3e3))):N(t=>({...t,[i]:{message:`⌛ Đang gửi lệnh tới agent... (${T}s)`,isPending:!0}}))}catch(I){clearInterval(k),N(P=>{const T={...P};return delete T[i],T}),o(I.message||"Lệnh thực hiện thất bại từ Agent")}},m)},[O]),Wr=p.useCallback(r=>{if(!r)return;const i=r.lan_uid,s=Date.now();if(!Wt.current[i]||s-Wt.current[i]>180*1e3){Wt.current[i]=s;const o=(r.agents||[]).filter(c=>c.is_agent_active);if(o.length>0){o.sort((g,m)=>{const d=new Date(g.last_seen||g.updated_at||g.last_ping||0).getTime();return new Date(m.last_seen||m.updated_at||m.last_ping||0).getTime()-d});const c=o[0];if(c){O(`⏳ Agent (${c.agent_uid}) đang thực hiện quét ngầm mạng LAN...`,"info",6e3);const g=c,d={command:"force_subnet_scan",command_content:`def force_scan():
...
try:
    ...
    print(f"[-] LỖI THỰC THI: {err}")`,lead:r.lead};fetch(`${ct}/ui/agents/${g.agent_uid}/utility/exec`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d)}).then(R=>R.json()).then(R=>{const k=(R==null?void 0:R.command_id)||(R==null?void 0:R.id);k?$e(Number(k),`scan_lan_${i}`,async I=>{console.log("[DEBUG_LAN_SCAN] pollData received from LAN scan:",I);let P=[];const T=(I==null?void 0:I.result)||(I==null?void 0:I.result_payload)||(I==null?void 0:I.raw);if(Array.isArray(T))P=T;else if(typeof T=="string")try{const t=JSON.parse(T);Array.isArray(t)&&(P=t)}catch{}P.length>0?(O(`✓ Quét mạng LAN hoàn tất, tìm thấy ${P.length} máy in!`,"success",4e3),b(t=>t.map(l=>l.lan_uid===i?{...l,printers:P.map((u,y)=>({id:u.id||9e4+y,...u}))}:l))):(O("✓ Quét mạng LAN hoàn tất, đang cập nhật danh sách máy photocopy...","success",4e3),await nt(!0))},async I=>{await nt(!0)},"⏳ Đang chờ Agent hoàn tất quét ngầm mạng LAN..."):setTimeout(()=>nt(!0),5e3)}).catch(R=>{console.error(R),setTimeout(()=>nt(!0),5e3)})}}}},[O,$e,nt]),dr=p.useCallback(r=>{var g;const i=Number(r),s=(g=Q==null?void 0:Q.printers)==null?void 0:g.find(m=>Number(m.id)===i);if(!s||!Q)return"";const o=(Q.agents||[]).filter(m=>m.is_agent_active),c=pt[i];return c&&o.some(d=>d.agent_uid===c)?c:s.agent_uid&&o.some(d=>d.agent_uid===s.agent_uid)?s.agent_uid:o.length>0?o[0].agent_uid:s.agent_uid||""},[Q,pt]),[pr,Rr]=p.useState({});p.useEffect(()=>{if(!Q||!Q.emails){Rr({});return}let r=!0;return(async()=>{const s={},o=Q.emails.filter(c=>c.email_type==="private");await Promise.all(o.map(async c=>{try{const g=await kn(Q.lan_uid,c.email);r&&(g.ok&&Array.isArray(g.rows)?s[c.email]=g.rows.length:s[c.email]=0)}catch(g){console.error(`Failed to fetch scan files count for ${c.email}`,g),r&&(s[c.email]=0)}})),r&&Rr(s)})(),()=>{r=!1}},[Q]);const[mn,Qt]=p.useState(!0),[un,Et]=p.useState(!0),[gn,mr]=p.useState(!1),[hn,Ee]=p.useState(null),[fn,ee]=p.useState(null),[ur,Vr]=p.useState([]),[Rt,Lr]=p.useState(!1),[_n,xn]=p.useState(""),[Fe,it]=p.useState({isOpen:!1,title:"",content:""}),[Yt,Kr]=p.useState("");p.useEffect(()=>{Fe.isOpen&&de.current&&(de.current.scrollTop=de.current.scrollHeight)},[Fe.isOpen,Fe.content,Yt]);const[yn,Mt]=p.useState(!1),[Jr,lt]=p.useState(null),vt=async()=>{if(!h)return;try{JSON.parse(Yt)}catch(s){lt(`❌ Lỗi định dạng JSON: ${s.message}`);return}Mt(!0),lt("⌛ Đang gửi cấu hình mới tới Agent...");const i=`import os, sys, json, base64
...
`;try{const s=await Lt(h.agent_uid,"save_settings_json",i);if(!s.ok||!s.command_id)throw new Error(s.error||"Không thể tạo lệnh tiện ích");const o=s.command_id,c=6e4,g=Date.now(),m=setInterval(async()=>{try{if(Date.now()-g>c){clearInterval(m),lt("❌ Lưu thất bại: Hết thời gian chờ (60s)"),Mt(!1);return}const R=await Ft(o);R.status==="success"?(clearInterval(m),lt("✔️ Đã lưu cấu hình và tự động reload thành công!"),Mt(!1),it(k=>({...k,content:Yt})),setTimeout(()=>lt(null),3e3)):(R.status==="failed"||!R.ok)&&(clearInterval(m),lt(`❌ Lỗi từ máy trạm: ${R.error||"Lưu thất bại"}`),Mt(!1))}catch(d){console.error("Poll error:",d)}},1e3)}catch(s){lt(`❌ Lỗi kết nối: ${s.message}`),Mt(!1)}},Zt=r=>{try{let i=r;for(;typeof i=="string";){const s=i.trim();if(s.startsWith("{")&&s.endsWith("}")||s.startsWith("[")&&s.endsWith("]")||s.startsWith('"')&&s.endsWith('"'))i=JSON.parse(i);else break}return typeof i=="object"&&i!==null?JSON.stringify(i,null,2):(typeof i=="string"&&(i=i.replace(/\\n/g,`
`).replace(/\\t/g,"	").replace(/\\"/g,'"').replace(/\\\\/g,"\\")),String(i))}catch{return r}};p.useEffect(()=>{Fe.isOpen&&Fe.title.includes("settings.json")&&(Kr(Zt(Fe.content)),lt(null))},[Fe.isOpen,Fe.title,Fe.content]);const gr=async(r,i,s)=>{try{const o=await Fn(void 0,void 0,r);if(o.ok&&o.jobs){const c=o.jobs.filter(g=>g.status==="pending");for(const g of c)if(g.command_type===i)try{const m=JSON.parse(g.command_params);let d=!0;for(const R of Object.keys(s))if(m[R]!==s[R]){d=!1;break}if(d)return!0}catch{if(g.command_params===JSON.stringify(s))return!0}}}catch(o){console.error("Failed to check duplicate pending jobs",o)}return!1},qe=new Set(["view_settings_json","view_stout","view_sterror","get_public_ip","check_watchdog","open_web_setting"]),Nr={view_settings_json:"⚙️ settings.json",view_stout:"📄 stout.txt — 100 dòng gần nhất",view_sterror:"🔴 sterror.txt — 100 dòng gần nhất",get_public_ip:"🌍 IP Public",check_watchdog:"🩺 Check Watchdog",open_web_setting:"🌐 Web setting"},hr=p.useCallback(async r=>{var i,s;if(r){mr(!0),ee(null);try{const o=await Mn(r.agent_uid);if(o.ok)Qt(!!o.scan_auto_open_file),Et(!!o.scan_auto_open_dir);else throw new Error(o.error||"Agent không tồn tại trên VPS")}catch(o){console.error("Failed to load agent settings:",o);const c=(i=o.message)!=null&&i.includes("Agent not found")||(s=o.message)!=null&&s.includes("404")?"Agent này chưa được đăng ký trên VPS backend. Vui lòng đảm bảo agent đang chạy và đã kết nối.":`Không thể tải cài đặt từ VPS: ${o.message}`;ee({text:c,isError:!0}),Qt(!0),Et(!0)}finally{mr(!1)}}},[]),fr=p.useCallback(async(r,i)=>{if(!h)return;const s=!i;r==="scan_auto_open_file"?Qt(s):Et(s);try{const o=await Un(h.agent_uid,{[r]:s});if(!o.ok)throw new Error(o.error||"Failed to update setting");ee({text:"Đã cập nhật cài đặt thành công.",isError:!1})}catch(o){console.error("Failed to update agent setting:",o),r==="scan_auto_open_file"?Qt(i):Et(i),ee({text:`Lỗi cập nhật cài đặt: ${o.message}`,isError:!0})}},[h]),bn=p.useCallback(async(r,i)=>{if(!h)return;const s=r==="printers"?"devices_and_printers":r==="scan"?"open_scan_folder":r==="change_ip"?"change_ip":r==="run_command"?"run_command":"dxdiag";if(await gr(h.agent_uid,"trigger_utility",{action:s,...i||{}})){O("Lệnh tiện ích này đang chờ phản hồi từ Agent!","info");return}Ee(r),ee({text:"⌛ Đang gửi lệnh tới Agent...",isError:!1});try{const c=await Bn(h.agent_uid,s,i);if(!c.ok||!c.command_id)throw new Error(c.error||"Không thể tạo lệnh tiện ích");const g=c.command_id,m=6e4,d=1e3,R=Date.now(),k=setInterval(async()=>{try{const I=Date.now()-R;if(I>m){clearInterval(k),ee({text:"Yêu cầu quá thời gian chờ (60s)",isError:!0}),Ee(null);return}const P=await Ft(g);if(P.status==="success")clearInterval(k),ee({text:"⚡ Thực hiện lệnh tiện ích thành công!",isError:!1}),Ee(null);else if(P.status==="failed"||!P.ok)clearInterval(k),ee({text:`❌ Thất bại: ${P.error||"Lệnh thất bại từ Agent"}`,isError:!0}),Ee(null);else{const T=Math.round(I/1e3);P.received_at?ee({text:`⚡ Agent đã nhận lệnh - đang mở tiện ích... (${T}s)`,isError:!1}):ee({text:`⌛ Đang chuyển lệnh tới Agent... (${T}s)`,isError:!1})}}catch(I){console.error("Error polling utility status:",I)}},d)}catch(c){console.error(`Failed to trigger ${r}:`,c),ee({text:`Lỗi kết nối hoặc gửi lệnh: ${c.message}`,isError:!0}),Ee(null)}},[h]),ft=p.useCallback(async(r,i)=>{var R;if(!h)return;if(await gr(h.agent_uid,"trigger_utility",{action:"exec_utility",command:r})){O("Yêu cầu chạy script/lệnh này đang chờ phản hồi từ Agent!","info");return}const o=ur.find(k=>k.command===r),c=(o==null?void 0:o.output_modal)||qe.has(r),g=(o==null?void 0:o.label)||Nr[r]||r;let m=i;if(r==="change_agent_ip"||r==="check_scan_ip_match"){const k=r==="change_agent_ip",I=(h==null?void 0:h.local_ip)||(h==null?void 0:h.ip)||(h==null?void 0:h.agent_ip)||(h==null?void 0:h.localIp)||"";if(jr({isOpen:!0,title:k?"🌐 Đổi địa chỉ IP tĩnh":"🔍 Kiểm tra IP khớp Copier",hint:k?"Nhập địa chỉ IPv4 tĩnh muốn gán cho máy Agent.":"Nhập địa chỉ IP muốn kiểm tra xem copier nào có FTP Scan entry khớp.",value:I,changeAllTo:"",scanStatus:k?"⏳ Loading... Đang quét điểm scan FTP trên máy photo...":"",error:"",onConfirm:(P,T)=>{const t=i.replace("__TARGET_IP__",P);Ee(r),ee({text:"⌛ Đang gửi lệnh tới Agent...",isError:!1}),Lt(h.agent_uid,r,t,{target_ip:P,ip:P,printer_ip:P,change_all_to:T||""}).then(l=>{if(!l.ok||!l.command_id)throw new Error(l.error||"Không thể tạo lệnh tiện ích");const u=l.command_id,y=6e4,L=Date.now(),M=setInterval(async()=>{try{const Ce=Date.now()-L;if(Ce>y){clearInterval(M),ee({text:"Yêu cầu quá thời gian chờ (60s)",isError:!0}),Ee(null);return}const pe=await Ft(u);if(pe.status==="success")clearInterval(M),c?(it({isOpen:!0,title:g,content:typeof pe.result_payload=="object"&&pe.result_payload?JSON.stringify(pe.result_payload,null,2):pe.result_payload||pe.error||pe.result||"(không có nội dung)"}),ee(null)):ee({text:"⚡ Thực hiện lệnh thành công!",isError:!1}),Ee(null);else if(pe.status==="failed"||!pe.ok)clearInterval(M),c?(it({isOpen:!0,title:g,content:pe.error||(typeof pe.result_payload=="object"&&pe.result_payload?JSON.stringify(pe.result_payload,null,2):pe.result_payload||pe.result||"(không có nội dung)")}),ee(null)):ee({text:`❌ Thất bại: ${pe.error||"Lệnh thất bại từ Agent"}`,isError:!0}),Ee(null);else{const Be=Math.round(Ce/1e3);ee({text:`⌛ Đang xử lý... (${Be}s)`,isError:!1})}}catch(Ce){console.error("Poll error:",Ce)}},1e3)}).catch(l=>{ee({text:`Lỗi: ${l.message}`,isError:!0}),Ee(null)})}}),k&&I){const P=ur.find(T=>T.command==="check_scan_ip_match");if(P&&P.command_content){const T=P.command_content.replace("__TARGET_IP__",I);Lt(h.agent_uid,"check_scan_ip_match",T,{target_ip:I,ip:I,printer_ip:I}).then(t=>{if(t.ok&&t.command_id){const l=Date.now(),u=setInterval(async()=>{if(Date.now()-l>4e4){clearInterval(u);return}try{const L=await Ft(t.command_id);if(L.status==="success"||L.status==="failed"){clearInterval(u);const M=L.result_payload||L.result||L.error||"";jr(Ce=>({...Ce,scanStatus:M?`🔍 ${M}`:""}))}}catch{}},1500)}}).catch(()=>{})}}return}const d=(R=Q==null?void 0:Q.printers)==null?void 0:R[0];m.includes("__TARGET_IP__")&&(m=m.replace(/__TARGET_IP__/g,(d==null?void 0:d.ip)||"192.168.1.155")),m.includes("__TARGET_USER__")&&(m=m.replace(/__TARGET_USER__/g,(d==null?void 0:d.auth_user)||(d==null?void 0:d.user)||"admin")),m.includes("__TARGET_PASS__")&&(m=m.replace(/__TARGET_PASS__/g,(d==null?void 0:d.auth_password)||(d==null?void 0:d.password)||"")),m.includes("__TARGET_ID__")&&(m=m.replace(/__TARGET_ID__/g,"001")),m.includes("__TARGET_SCAN_USER__")&&(m=m.replace(/__TARGET_SCAN_USER__/g,"scan")),r.includes("toshiba")&&(m=m.replace(/timeout=\d+/g,"timeout=25")),Ee(r),ee({text:"⌛ Đang gửi lệnh tới Agent...",isError:!1});try{const k=await Lt(h.agent_uid,r,m);if(!k.ok||!k.command_id)throw new Error(k.error||"Không thể tạo lệnh tiện ích");const I=k.command_id,P=6e4,T=Date.now(),t=setInterval(async()=>{try{const l=Date.now()-T;if(l>P){clearInterval(t),ee({text:"Yêu cầu quá thời gian chờ (60s)",isError:!0}),Ee(null);return}const u=await Ft(I);if(u.status==="success")clearInterval(t),c?(it({isOpen:!0,title:g,content:typeof u.result_payload=="object"&&u.result_payload?JSON.stringify(u.result_payload,null,2):u.result_payload||u.error||u.result||"(không có nội dung)"}),ee(null)):ee({text:"⚡ Thực hiện lệnh thành công!",isError:!1}),Ee(null);else if(u.status==="failed"||!u.ok)clearInterval(t),c?(it({isOpen:!0,title:g,content:u.error||(typeof u.result_payload=="object"&&u.result_payload?JSON.stringify(u.result_payload,null,2):u.result_payload||u.result||"(không có nội dung)")}),ee(null)):ee({text:`❌ Thất bại: ${u.error||"Lệnh thất bại từ Agent"}`,isError:!0}),Ee(null);else{const y=Math.round(l/1e3),L=u.progress_text||`Đang xử lý... (${y}s)`;ee({text:`⌛ ${L}`,isError:!1})}}catch(l){const u=(l==null?void 0:l.message)||String(l||"");c&&(u.startsWith("[PATH]")||u.includes("stout")||u.includes("sterror")||u.includes("settings.json"))?(clearInterval(t),it({isOpen:!0,title:g,content:u}),ee(null),Ee(null)):console.error("Poll error:",l)}},1e3)}catch(k){ee({text:`Lỗi: ${k.message}`,isError:!0}),Ee(null)}},[h,ur]),V=p.useCallback(async()=>{if(!h)return;if(await gr(h.agent_uid,"emergency_restart",{action:"emergency_restart"})){O("Yêu cầu khởi động lại Agent đang chờ phản hồi từ Agent!","info");return}Pe({isOpen:!0,title:"🚨 Kích hoạt Khởi động khẩn cấp",message:"Lệnh này sẽ đánh dấu yêu cầu thoát khẩn cấp cho Agent này trên server. File watchdog.bat (nếu có trên máy client) sẽ tự động phát hiện và ép đóng printagent.exe rồi mở lại. Việc này giúp thoát khỏi tình trạng treo update. Bạn có chắc chắn muốn thực hiện?",onConfirm:async()=>{Ee("emergency_restart"),ee({text:"⌛ Đang đăng ký cờ khởi động lại khẩn cấp...",isError:!1});try{const i=await Gn(h.agent_uid);if(!i.ok)throw new Error(i.error||"Thất bại");ee({text:"⚡ Đã lưu cờ tắt khẩn cấp trên Server. Chờ Watchdog quét...",isError:!1})}catch(i){ee({text:`❌ Lỗi: ${i.message}`,isError:!0})}finally{Ee(null)}}})},[h]);p.useEffect(()=>{Se==="utilities"&&h&&(hr(h),Lr(!0),wn(h.agent_uid).then(r=>{r!=null&&r.ok&&Array.isArray(r.commands)&&Vr(r.commands)}).catch(r=>console.error("Failed to load utility commands:",r)).finally(()=>Lr(!1)))},[Se,h,hr]);const _r=p.useMemo(()=>{if(!Q)return[];const r=(Q.printers||[]).filter(i=>{const s=(i.printer_name||"").toLowerCase().trim();return!(s.includes("unknown")||s==="unknown printer"||s.includes("pdf")||s.includes("fax")||s.includes("brother")||s.includes("canon lbp")||s.includes("rustdesk")||i.probed&&!i.is_online)});return or?[...r].sort((i,s)=>{const o=String(i.id)===or,c=String(s.id)===or;return o&&!c?-1:!o&&c?1:0}):r},[Q,or]),qr=r=>{localStorage.setItem("goxprint_last_viewed_copier_id",r)};p.useEffect(()=>{if(Q){const r={};Q.printers.forEach(i=>{const s=(Q.agents||[]).filter(c=>c.is_agent_active),o=s.find(c=>c.agent_uid===i.agent_uid)||s[0];r[i.id]=o?o.agent_uid:i.agent_uid||""}),_e(i=>({...r,...i})),Ge(i=>{const s={...i};return Q.printers.forEach(o=>{const c=o.auth_user||o.user||"",g=o.auth_password||o.password||"",m=(()=>{try{const I=localStorage.getItem(`copier_auth_${o.id}`)||(o.mac_id?localStorage.getItem(`copier_auth_${o.mac_id}`):null);return I?JSON.parse(I):null}catch{return null}})(),d=s[o.id],R=(d==null?void 0:d.user)!==void 0?d.user:c!==""?c:(m==null?void 0:m.user)!==void 0?m.user:"",k=(d==null?void 0:d.pass)!==void 0?d.pass:g!==""?g:(m==null?void 0:m.pass)!==void 0?m.pass:"";s[o.id]={user:R,pass:k}}),s})}},[Q]);const Xr=async r=>{const i=String(typeof r=="object"?r.id:r),s=typeof r=="object"?r.mac_id||r.mac_address||"":i,o=typeof r=="object"&&(r.printer_type||r.type)||"",c=te[i]||{user:"",pass:""};try{localStorage.setItem(`copier_auth_${i}`,JSON.stringify(c)),s&&localStorage.setItem(`copier_auth_${s}`,JSON.stringify(c))}catch{}Ke(g=>({...g,[i]:!0}));try{const g=await Pn(s||i,c.user,c.pass,s,o);if(g.ok){const m=g.command_id||g.id;m?(O("Đã tạo lệnh lưu Auth, đang đợi Agent thực thi và ghi vào đĩa...","info",3e3),$e(m,i,d=>{const R=d!=null&&d.error?` (${d.error})`:d!=null&&d.result?` (${d.result})`:"";O(`Đã test đăng nhập thành công và lưu vào database!${R}`,"success",5e3),b(k=>k.map(I=>({...I,printers:I.printers.map(P=>String(P.id)===String(i)||s&&P.mac_id===s?{...P,auth_user:c.user,auth_password:c.pass}:P)}))),Ke(k=>({...k,[i]:!1}))},d=>{O(`Lỗi Agent lưu Auth: ${d}`,"error"),Ke(R=>({...R,[i]:!1}))},"Đang thực thi lưu tài khoản vào tệp printers.json...")):(O("Đã lưu tài khoản Web UI máy photocopy thành công","success"),b(d=>d.map(R=>({...R,printers:R.printers.map(k=>String(k.id)===String(i)||s&&k.mac_id===s?{...k,auth_user:c.user,auth_password:c.pass}:k)}))),Ke(d=>({...d,[i]:!1})))}else throw new Error(g.error||"Lưu thất bại")}catch(g){O(`Lỗi lưu Auth: ${g.message}`,"error"),Ke(m=>({...m,[i]:!1}))}},ne=async(r,i,s,o,c)=>{try{const m=await(await fetch(`${ct}/api/scan-points/save`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mac_id:r,address_book_data:i,printer_name:s||"Photocopy",ip:o||"",agent_uid:c||""})})).json();console.log("Saved scan point to DB:",m)}catch(g){console.error("Failed to save scan point to DB:",g)}},et=async r=>{var R,k,I,P,T;const i=(A||[]).flatMap(t=>t.printers||[]),s=typeof r=="object"&&r!==null?r:i.find(t=>String(t.id)===String(r)||t.mac_id===r||t.mac_address===r||t.ip===r)||((R=Q==null?void 0:Q.printers)==null?void 0:R.find(t=>String(t.id)===String(r)||t.mac_id===r||t.mac_address===r||t.ip===r))||{},o=String(s.id||(typeof r=="string"?r:"")),c=s.ip||s.printer_ip||(typeof r=="string"&&r.includes(".")?r:""),g=s.mac_address||s.mac_id||(typeof r=="string"&&r.includes(":")?r:o);if(!c){O("Thiếu thông tin IP máy in hợp lệ. Vui lòng chọn máy in cụ thể.","error");return}const m=dr(o)||dr(c)||dr(g);O("Bắt đầu gửi yêu cầu đồng bộ danh bạ máy in...","info",3e3);const d=g?String(g).toUpperCase().replace(/-/g,":"):"";d&&ye(t=>({...t,[d]:{status:"loading",address_list:[]}}));try{const t=((k=te[o])==null?void 0:k.user)||((I=te[c])==null?void 0:I.user)||s.auth_user||s.user,l=((P=te[o])==null?void 0:P.pass)||((T=te[c])==null?void 0:T.pass)||s.auth_password||s.password||"";if(!t){O(`Chưa cấu hình tài khoản Web cho máy in ${s.printer_name||s.name||"Photocopy"}!`,"error"),d&&ye(M=>({...M,[d]:{status:"error",address_list:[]}}));return}const L=await En(c&&c!=="0.0.0.0"?c:g||o,m||void 0,{mac_address:g,printer_ip:c,ip:c,auth_user:t,auth_password:l});if(!L.ok||!L.command_id)throw new Error(L.error||"Không thể tạo lệnh đồng bộ");$e(L.command_id,o,async M=>{const Ce=g?String(g).toUpperCase().replace(/-/g,":"):"";let pe=(M==null?void 0:M.address_book_sync)||(M==null?void 0:M.address_book_data);if(!pe&&(M!=null&&M.result||M!=null&&M.result_payload)){const Be=String(M.result||M.result_payload||"");if(Be.includes("__ADDRESS_BOOK_JSON_START__"))try{let Dr=Be.split("__ADDRESS_BOOK_JSON_START__")[1].split("__ADDRESS_BOOK_JSON_END__")[0].trim();Dr=Dr.replace(/^(\n|\r|\\n|\\r)+|(\n|\r|\\n|\\r)+$/g,"").trim(),pe=JSON.parse(Dr)}catch{}}Ce&&pe&&(ye(Be=>({...Be,[Ce]:pe})),ne(Ce,pe,s.printer_name||s.name,s.ip||s.printer_ip,m)),await nt(),fe(Be=>({...Be,[o]:!0}))},M=>{O(`Đồng bộ thất bại: ${M}`,"error")},"⌛ Đang đồng bộ danh bạ...")}catch(t){O(`Lỗi gửi lệnh đồng bộ: ${t.message}`,"error")}};return{VIEW_COMMANDS:qe,activeAgentUid:$r,activeLoadingFile:ge,activeModal:Se,activeTab:x,allocatedVncAddr:vr,autoScanTriggers:Wt,cameraFiles:gt,cameraForm:Ct,cameraLogs:xt,cameraStatus:Nt,cameraTestLoading:j,cameraTestResult:Ut,cameras:Re,camerasLoading:Ye,commandStatus:ae,confirmModal:Ar,copierCredentials:te,customRecordDuration:F,customRunCommand:_n,deleteScanPointModal:Me,detectBrand:Tr,directLan:zt,editIpModalData:Cr,editableSettingsText:Yt,emailFileCounts:pr,expandedDriverMenus:w,expandedDrivers:Qe,expandedPrinters:he,fetchCameraFiles:async(r,i)=>{try{const o=await(await fetch(`${ct}/api/agents/${r}/cameras/${i}/files`,{method:"POST"})).json();o.ok&&yt(o.files||[])}catch{}},fetchCameraStatus:async(r,i)=>{try{const o=await(await fetch(`${ct}/api/agents/${r}/cameras/${i}/status`,{method:"POST"})).json();o.ok&&o.status?(mt(o.status),ut(o.status.logs||[])):O("Không lấy được trạng thái camera: "+(o.error||"Lỗi kết nối"),"error")}catch(s){O("Lỗi lấy trạng thái: "+s.message,"error")}},fetchCameras:pn,fetchLanSitesData:nt,fetchRemotePage:Pt,filteredPrinters:_r,formatJsonText:Zt,ftpDetailData:ce,getLiveQueryTimestamp:ht,getTargetAgentUid:dr,handleAddPrivateFtp:async()=>{const{lanUid:r,agentUid:i,email:s}=Gr;if(!s||!s.includes("@")){O("Địa chỉ email không hợp lệ","error");return}St(!0);try{const o=await Ln("default",r,i,s);if(St(!1),re(null),o.ok)O("Đã thêm Private FTP thành công","success"),await nt();else throw new Error(o.error||"Lỗi server")}catch(o){St(!1),O(`Lỗi thêm FTP riêng: ${o.message}`,"error")}},handleAddPublicFtp:async()=>{var c,g,m;const{printerId:r,name:i,email:s,agentUid:o}=Jt;if(!i||!i.trim()){O("Vui lòng nhập tên điểm scan","error");return}if(s&&!s.includes("@")){O("Địa chỉ email không hợp lệ","error");return}qt(!0),O("Đang tạo yêu cầu thêm FTP/Email lên máy in...","info",3e3);try{const d=(c=Q==null?void 0:Q.printers)==null?void 0:c.find(T=>String(T.id)===String(r)||T.mac_id===r),R=((g=te[r])==null?void 0:g.user)||(d==null?void 0:d.auth_user),k=((m=te[r])==null?void 0:m.pass)||(d==null?void 0:d.auth_password)||"";if(!R){qt(!1),O(`Chưa cấu hình tài khoản Web cho máy in ${(d==null?void 0:d.printer_name)||(d==null?void 0:d.name)||"Photocopy"}!`,"error");return}const I={mac_address:(d==null?void 0:d.mac_id)||(d==null?void 0:d.mac_address)||r,printer_ip:(d==null?void 0:d.ip)||"",auth_user:R,auth_password:k},P=await Rn(r,i.trim(),s,o||void 0,I);if(qt(!1),re(null),!P.ok||!P.command_id)throw new Error(P.error||"Lỗi gửi lệnh");$e(P.command_id,r,async T=>{O(`Đã tạo điểm scan "${i.trim()}" thành công!`,"success"),console.log("Finish add public FTP scan point, updating address book state directly");const t=(d==null?void 0:d.mac_address)||(d==null?void 0:d.mac_id)||r,l=t?String(t).toUpperCase().replace(/-/g,":"):"";let u=(T==null?void 0:T.address_book_sync)||(T==null?void 0:T.address_book_data);if(!u&&(T!=null&&T.result||T!=null&&T.result_payload)){const y=String(T.result||T.result_payload||"");if(y.includes("__ADDRESS_BOOK_JSON_START__"))try{let L=y.split("__ADDRESS_BOOK_JSON_START__")[1].split("__ADDRESS_BOOK_JSON_END__")[0].trim();L=L.replace(/^(\n|\r|\\n|\\r)+|(\n|\r|\\n|\\r)+$/g,"").trim(),u=JSON.parse(L)}catch{}}l&&u&&ye(y=>({...y,[l]:u})),et(r),await nt()},T=>{O(`Thêm điểm scan thất bại: ${T}`,"error")},`⌛ Đang tạo điểm scan "${i.trim()}"...`)}catch(d){qt(!1),O(`Lỗi: ${d.message}`,"error")}},handleCloseWebPreview:dn,handleCopierClick:qr,handleEmergencyRestart:V,handleHistoryBack:ln,handleHistoryForward:lr,handleRefetchAddressBook:et,handleSaveAuth:Xr,handleSaveSettings:vt,handleToggleDirectLan:cn,handleToggleSetting:fr,handleTriggerUtility:bn,handleTriggerUtilityExec:ft,handleViewScanPointsJson:on,installDriverModal:Tt,ipInputModal:Zr,isDuplicatePending:gr,isRecording30s:le,isSavingSettings:yn,lanSites:A,lanSitesLoading:be,liveAddressBooks:xe,loadUtilitySettings:hr,lockAspect:It,modalContentRef:de,onlineAgents:cr,pollCommandStatus:$e,previewBlobUrl:Ht,previewIframeRef:$t,privateFtpData:Gr,privateFtpLoading:Pr,publicFtpData:Jt,publicFtpLoading:nn,queriedVideoUrl:f,queryDuration:W,queryTimestamp:q,queryVideoLoading:Z,recording30sCountdown:Le,remoteLockPrinter:Bt,replaceToast:zr,resolveRelativePath:Er,saveAuthLoading:dt,saveScanPointToDb:ne,scaleX:jt,scaleY:Oe,scanAutoOpenDir:un,scanAutoOpenFile:mn,scanPointsViewerModal:an,selectedCamera:He,selectedCameraAgentUid:me,selectedLan:Q,selectedLanUid:Y,selectedTargetAgents:pt,selectedUtilityAgent:h,setActiveLoadingFile:Te,setActiveModal:re,setActiveTab:ue,setAllocatedVncAddr:er,setCameraFiles:yt,setCameraForm:H,setCameraLogs:ut,setCameraStatus:mt,setCameraTestLoading:G,setCameraTestResult:E,setCameras:J,setCamerasLoading:Je,setCommandStatus:N,setConfirmModal:Pe,setCopierCredentials:Ge,setCustomRecordDuration:je,setCustomRunCommand:xn,setDeleteScanPointModal:ar,setDirectLan:wr,setEditIpModalData:kr,setEditableSettingsText:Kr,setEmailFileCounts:Rr,setExpandedDriverMenus:we,setExpandedDrivers:U,setExpandedPrinters:fe,setFtpDetailData:br,setInstallDriverModal:Yr,setIpInputModal:jr,setIsRecording30s:ze,setIsSavingSettings:Mt,setLanSites:b,setLanSitesLoading:se,setLiveAddressBooks:ye,setLockAspect:bt,setPreviewBlobUrl:De,setPrivateFtpData:sn,setPrivateFtpLoading:St,setPublicFtpData:Br,setPublicFtpLoading:qt,setQueriedVideoUrl:C,setQueryDuration:z,setQueryTimestamp:$,setQueryVideoLoading:D,setRecording30sCountdown:tt,setRemoteLockPrinter:Sr,setSaveAuthLoading:Ke,setScaleX:sr,setScaleY:Ot,setScanAutoOpenDir:Et,setScanAutoOpenFile:Qt,setScanPointsViewerModal:Xt,setSelectedCamera:ke,setSelectedCameraAgentUid:Ae,setSelectedLanUid:K,setSelectedTargetAgents:_e,setSelectedUtilityAgent:at,setSettingsSaveStatus:lt,setShowPreviewDetails:Ur,setShowSettings:_,setStorageFiles:Ir,setStorageLoading:rn,setStorageModalData:en,setToasts:B,setToshibaVncData:Gt,setUtilityActionPending:Ee,setUtilityCommands:Vr,setUtilityCommandsLoading:Lr,setUtilitySettingsLoading:mr,setUtilityStatusMsg:ee,setViewOutputModal:it,setVncTunnelLoading:rr,setWebPreviewHistory:Ne,setWebPreviewHistoryIndex:At,setWebPreviewLoading:ir,setWebPreviewModal:kt,setWebPreviewTab:Ze,settingsSaveStatus:Jr,showPreviewDetails:Fr,showSettings:S,showToast:O,storageFiles:tn,storageLoading:Kt,storageModalData:Vt,toasts:Ie,toshibaVncData:ve,triggerLanScan:Wr,utilityActionPending:hn,utilityCommands:ur,utilityCommandsLoading:Rt,utilitySettingsLoading:gn,utilityStatusMsg:fn,viewOutputModal:Fe,vncTunnelLoading:tr,webPreviewHistory:Dt,webPreviewHistoryIndex:ot,webPreviewLoading:nr,webPreviewModal:X,webPreviewTab:Mr}},yr="https://agentapi.quanlymay.com",Jn=(a={})=>{const{cameraForm:v,cameras:A,customRecordDuration:b,directLan:Y,fetchCameraFiles:K,fetchCameraStatus:be,fetchCameras:se,isRecording30s:me,setActiveModal:Ae,setAllocatedVncAddr:x,setCameraTestLoading:ue,setCameraTestResult:ae,setIsRecording30s:N,setRecording30sCountdown:he,setSelectedCamera:fe,setToshibaVncData:Qe,setVncTunnelLoading:U,showToast:w}=a;return{cameraForm:v,cameras:A,customRecordDuration:b,directLan:Y,fetchCameraFiles:K,fetchCameraStatus:be,fetchCameras:se,handleDeleteCamera:async(_e,xe)=>{if(window.confirm("Bạn có chắc chắn muốn xóa cấu hình camera này?"))try{const ye=await(await fetch(`${yr}/api/agents/${_e}/cameras/${xe}/delete`,{method:"POST"})).json();ye.ok?(w("Đã xóa camera thành công!","success"),se(_e),fe(null)):w("Lỗi xóa camera: "+ye.error,"error")}catch(oe){w("Lỗi hệ thống: "+oe.message,"error")}},handleDeleteCameraFile:async(_e,xe,oe)=>{if(window.confirm(`Bạn có chắc chắn muốn xóa tệp video này khỏi máy trạm?
File: ${oe}`))try{const Re=await(await fetch(`${yr}/api/agents/${_e}/cameras/${xe}/delete-file`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({filename:oe})})).json();Re.ok?(w("Đã xóa tệp video thành công!","success"),K(_e,xe)):w("Lỗi xóa tệp: "+Re.error,"error")}catch(ye){w("Lỗi hệ thống: "+ye.message,"error")}},handleRecord30s:async(_e,xe)=>{if(me)return;const oe=A.find(Ye=>Ye.id===xe),ye=(oe==null?void 0:oe.mac_address)||"";if(!ye){w("Camera không có thông tin MAC ID để điều khiển!","error");return}N(!0),he(b);let Re=b;const J=setInterval(()=>{Re-=1,he(Math.max(Re,0)),Re<=0&&clearInterval(J)},1e3);try{w(`Đang gửi yêu cầu ghi hình ${b}s...`,"info");const Je=await(await fetch(`${yr}/api/cameras/record-control`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mac_id:ye,action:"record",duration:b})})).json();clearInterval(J),Je.ok?w(Je.message||`Ghi hình ${b}s hoàn tất!`,"success"):w("Lỗi ghi hình: "+Je.error,"error")}catch(Ye){clearInterval(J),w("Lỗi kết nối ghi hình: "+Ye.message,"error")}finally{N(!1),setTimeout(()=>{be(_e,xe),K(_e,xe)},1500)}},handleSaveCameraConfig:async _e=>{try{const oe=await(await fetch(`${yr}/api/agents/${_e}/cameras`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(v)})).json();oe.ok?(w("Đã lưu cấu hình camera thành công!","success"),se(_e),fe(null)):w("Lỗi lưu cấu hình: "+oe.error,"error")}catch(xe){w("Lỗi hệ thống: "+xe.message,"error")}},handleStartToshibaVnc:async(_e,xe,oe)=>{if(Qe({ip:_e,printerName:xe,agentUid:oe}),x(""),Ae("toshiba_vnc"),Y){x(`${_e}:49105`);return}U(!0);try{const Re=await(await fetch(`${yr}/api/agents/${oe}/tunnel/start`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({printer_ip:_e,printer_port:49105})})).json();if(Re.ok&&Re.url_port){const J=Re.url_port.replace("http://","").replace("https://","");x(J)}else w("Không thể mở đường hầm VNC: "+(Re.error||"Lỗi không xác định"),"error"),Ae(null)}catch(ye){w("Lỗi kết nối VPS: "+(ye.message||ye),"error"),Ae(null)}finally{U(!1)}},handleTestCameraConnection:async _e=>{ue(!0),ae(null);try{const oe=await(await fetch(`${yr}/api/agents/${_e}/cameras/0/test`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({rtsp_url:v.rtsp_url})})).json();oe.ok&&oe.result?ae(oe.result):ae({ok:!1,msg:oe.error||"Lỗi kiểm tra kết nối"})}catch(xe){ae({ok:!1,msg:"Lỗi: "+xe.message})}finally{ue(!1)}},isRecording30s:me,setActiveModal:Ae,setAllocatedVncAddr:x,setCameraTestLoading:ue,setCameraTestResult:ae,setIsRecording30s:N,setRecording30sCountdown:he,setSelectedCamera:fe,setToshibaVncData:Qe,setVncTunnelLoading:U,showToast:w}},qn={ricoh_create_scan:`import requests
import re
import base64
import json
import time
