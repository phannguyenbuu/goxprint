...
def reset_single_toshiba_template(ip, user, password, target_id):
    ...
    for target_url in base_urls:
        ...
        try:
            r_boot = session.get(landing_url, verify=False, timeout=20)
...
<Command>
    <Login>
        ...
        <Params><appName>TOPACCESS</appName></Params>
            ...
            try:
                r_log = session.post(f"{target_url}/contentwebserver", data=login_xml.encode('utf-8'), headers=headers, verify=False, timeout=20)
    ...
    try:
        r_lic = session.post(f"{working_base_url}/contentwebserver", data=license_xml.encode('utf-8'), headers=headers, verify=False, timeout=20)
    ...
    for act_name, xml_data in all_payloads:
        try:
            ...
            r_del = session.post(f"{working_base_url}/contentwebserver", data=xml_data.encode('utf-8'), headers=headers, verify=False, timeout=20)
    ...
    try:
        r_tmpl = session.post(f"{working_base_url}/contentwebserver", data=get_templates_xml.encode('utf-8'), headers=headers, verify=False, timeout=20)
    ...
    try:
        session.post(f"{working_base_url}/contentwebserver", data=logout_xml.encode('utf-8'), headers=headers, verify=False, timeout=20)
    ...
    try:
        ...
        r_groups = session.post(f"{working_base_url}/contentwebserver", data=get_groups_xml.encode('utf-8'), headers=headers, verify=False, timeout=20)
